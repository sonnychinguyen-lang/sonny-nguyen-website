...
import { AttributeManager, log, project32 } from '@deck.gl/core';
...
import maxSource from "./max.wgsl.js";
import weightsSource from "./weights.wgsl.js";
...
class HeatmapLayer extends AggregationLayer {
    ...
    _setupTextureParams() {
        ...
        const format = floatTargetSupport
            ? isWebGPU
                ? 'rgba16float'
                : 'rgba32float'
            : 'rgba8unorm';
    ...
    _setupResources() {
        ...
        const maxWeightTransform = new TextureTransform(device, {
            ...
            ...(device.type === 'webgpu'
                ? { colorAttachmentFormats: [maxWeightsTexture.format] }
                : {}),
            vertexCount: device.type === 'webgpu'
