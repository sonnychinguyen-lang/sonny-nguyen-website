...
import MapView from "../../core/src/views/map-view.js";
...
function getZoom(view, longitude, latitude, width, height) {
    ...
    if (focalPoint && focalPointRight) {
        ...
        if (horizontalMetersPerPixel > 0) {
            ...
            return Math.log2((DECK_GROUND_MPP_AT_ZOOM_0 * Math.cos(latitudeRad)) / horizontalMetersPerPixel);
        }
    }
        ...
        constructor(viewOrProps, props) {
            ...
            const DeckRenderNode = RenderNode.createSubclass({
                ...
                render(inputs) {
                    ...
                    const arcgisMatrixView = getArcGISMatrixViewState(self.view, longitude, latitude, zoom, self.view.resolution, altitude);
                    try {
                        if (arcgisMatrixView) {
