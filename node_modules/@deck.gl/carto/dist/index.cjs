...
var CellsReader = class _CellsReader {
  static read(pbf, end) {
    return pbf.readFields(_CellsReader._readField, { indices: null, properties: [], numericProps: {} }, end);
  }
  static _readField(tag, obj, pbf) {
    if (tag === 1)
...
var VERSION2 = true ? "9.4.0" : "latest";
...
var VERSION3 = true ? "9.4.0" : "latest";
...
var VERSION4 = true ? "9.4.0" : "latest";
