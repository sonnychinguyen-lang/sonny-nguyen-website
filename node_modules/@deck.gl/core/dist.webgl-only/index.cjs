...
var import_constants8 = require("@luma.gl/webgl/constants");
...
var DataColumn = class {
  ...
  _createBuffer(byteLength) {
    ...
    const usage = false ? import_core17.Buffer.VERTEX | import_core17.Buffer.STORAGE | import_core17.Buffer.COPY_DST | import_core17.Buffer.COPY_SRC : (isIndexed ? import_core17.Buffer.INDEX : import_core17.Buffer.VERTEX) | import_core17.Buffer.COPY_DST;
