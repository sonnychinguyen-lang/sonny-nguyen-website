...
export default class DataColumn {
    ...
    _getBufferLayout(attributeName = this.id, options = null) {
        ...
        const result = {
            ...
            byteStride: false && this.state.constant ? 0 : getStride(accessor)
        };
        if (this.doublePrecision) {
    ...
    updateSubBuffer(opts = {}) {
        ...
        this.buffer.write(splitDoublePrecisionValue
    ...
    allocate(numInstances, copy = false) {
        ...
        this.value = value;
        const splitDoublePrecisionValue = this._shouldSplitDoublePrecisionValue(value);
        const accessor = splitDoublePrecisionValue && value instanceof Float32Array
        ...
        if (!buffer || buffer.byteLength < bufferByteLength + byteOffset) {
            ...
            if (copy && oldValue) {
                ...
                buffer.write(this._shouldSplitDoublePrecisionValue(oldValue)
    ...
    _shouldSplitDoublePrecisionValue(value) {
        return Boolean(this.doublePrecision &&
            (value instanceof Float64Array ||
                (false && value instanceof Float32Array)));
    }
