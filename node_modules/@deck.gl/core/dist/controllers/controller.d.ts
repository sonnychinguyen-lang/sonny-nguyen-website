...
import { IViewState, type ConstraintContext } from "./view-state.js";
import type { MaxBoundsPadding } from "./utils.js";
...
export default abstract class Controller<ControllerState extends IViewState<ControllerState>> {
    ...
    protected pickPosition?: (x: number, y: number) => {
        coordinate?: number[];
    } | null;
    ...
    private _panMove;
    private _multiPanMode;
    private _multiPanStartCenter;
    private _doubleClickDragAnchor;
    private _suppressDoubleClickUntil;
    ...
    protected doubleClickDragZoom: boolean;
    protected touchZoom: boolean;
    protected touchRotate: boolean;
    protected multiTouchDrag: 'pan' | 'rotate' | null;
    protected trackpadGesture: boolean;
    protected zoomAround: 'center' | 'pointer';
    ...
    protected _getConstraintContext(_action: 'pan' | 'rotate' | 'zoom', phase: 'start' | 'update' | 'end'): ConstraintContext;
    ...
    private _isTrackpadGestureAllowed;
    private _isMultiPanEventAllowed;
    private _getMultiPanEvent;
    private _resetMultiPan;
