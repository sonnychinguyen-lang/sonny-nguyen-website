import Controller, { ControllerProps, InteractionState } from "./controller.js";
import ViewState, { type ConstraintContext } from "./view-state.js";
...
export declare class MapState extends ViewState<MapState, MapStateProps, MapStateInternal> {
    ...
    panStart({ pos }: {
        pos: [number, number];
    }, constraintContext?: ConstraintContext): MapState;
    /**
     * Pan
    ...
    zoomIn(speed?: number, constraintContext?: ConstraintContext): MapState;
    zoomOut(speed?: number, constraintContext?: ConstraintContext): MapState;
    moveLeft(speed?: number, constraintContext?: ConstraintContext): MapState;
    moveRight(speed?: number, constraintContext?: ConstraintContext): MapState;
    moveUp(speed?: number, constraintContext?: ConstraintContext): MapState;
    moveDown(speed?: number, constraintContext?: ConstraintContext): MapState;
    ...
    applyConstraints(props: Required<MapStateProps>, constraintContext?: ConstraintContext): Required<MapStateProps>;
    _constrainZoom(zoom: number, props?: Required<MapStateProps>): number;
    _zoomFromCenter(scale: any, constraintContext?: ConstraintContext): MapState;
    _panFromCenter(offset: any, constraintContext?: ConstraintContext): MapState;
    _getUpdatedState(newProps: any, constraintContext?: ConstraintContext): MapState;
...
export default class MapController extends Controller<MapState> {
     ...
     */
    protected rotationPivot: 'center' | '2d' | '3d';
