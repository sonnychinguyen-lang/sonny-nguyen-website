...
export declare const CONSTRAINT_AROUND: unique symbol;
...
export default abstract class ViewState<T, Props extends Record<string, any>, State extends Record<string, any>> implements IViewState<T> {
    ...
    constructor(props: Required<Props>, state: State, makeViewport: (props: Record<string, any>) => Viewport, constraintContext?: ConstraintContext);
    getViewportProps(): Required<Props>;
    getState(): State;
    abstract applyConstraints(props: Required<Props>, constraintContext?: ConstraintContext): Required<Props>;
