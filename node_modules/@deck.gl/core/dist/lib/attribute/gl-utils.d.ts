...
export declare const dataTypeFromTypedArray: (arrayOrType: import("@math.gl/types").TypedArray | import("@luma.gl/core").TypedArrayConstructor) => import("@luma.gl/core").SignedDataType;
export declare function getBufferAttributeLayout(name: string, accessor: BufferAccessor, deviceType: 'webgpu' | 'webgl' | string): BufferAttributeLayout | null;
