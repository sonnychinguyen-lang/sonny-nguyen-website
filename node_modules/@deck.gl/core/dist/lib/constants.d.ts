...
export declare const RECOGNIZERS: {
    readonly multipan: readonly [typeof Pan, {
        ...
        readonly pointers: 2;
        readonly trackpad: true;
    }];
    readonly pinch: readonly [typeof Pinch, {
        readonly trackpad: true;
    }, null, readonly ["multipan"]];
    ...
    readonly dblclickdrag: readonly [typeof DoubleClickDrag, {
        readonly event: "dblclickdrag";
        readonly enable: false;
    }, readonly ["dblclick"], null];
    readonly click: readonly [typeof Tap, {
        readonly event: "click";
    }, readonly ["dblclickdrag"], readonly ["dblclick", "dblclickdrag"]];
};
