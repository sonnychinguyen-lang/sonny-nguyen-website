...
import type { CanvasContext, Device, Framebuffer, Parameters, PresentationContext } from '@luma.gl/core';
...
export type DeckProps<ViewsT extends ViewOrViews = null> = {
    ...
    onResize?: (dimensions: {
        width: number;
        height: number;
    }, canvasContext?: CanvasContext) => void;
...
export default class Deck<ViewsT extends ViewOrViews = null> {
    ...
    private _syncCanvasTargets;
    private _setCanvasContext;
    private _setDeviceCanvasContext;
    private _setDeviceResizeHandler;
    private _restoreDeviceResizeHandler;
     ...
     */
    private _updateMultiCanvasDimensions;
