import type { CanvasContext, Parameters, PresentationContext } from '@luma.gl/core';
...
export default class LayersPass extends Pass {
    ...
    protected _getDrawLayerParams(viewport: Viewport, { layers, pass, isPicking, layerFilter, cullRect, views, effects, canvasContext, shaderModuleProps }: LayersPassRenderOptions, 
