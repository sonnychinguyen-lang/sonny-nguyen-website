...
export declare function getProjectionParameters(projectionMatrix: Matrix4 | NumericArray): {
    near: number;
    far: number;
};
 ...
 */
export declare function toDoublePrecisionArray(typedArray: Float32Array | Float64Array, options: {
    size?: number;
    startIndex?: number;
    endIndex?: number;
}): Float32Array;
