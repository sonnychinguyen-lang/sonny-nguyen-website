...
import { getMercatorReferenceViewport, joinLayerBounds, lngLatToMercatorCommon, makeViewport, getRenderBounds } from "../utils/projection-utils.js";
/**
...
export class TerrainCover {
    ...
    _updateViewport(viewport) {
        ...
        if (this.tile) {
            ...
            const newBounds = viewport instanceof GlobeViewport
                ? this.targetBoundsCommon
