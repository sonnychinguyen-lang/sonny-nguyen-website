...
export declare function lngLatToMercatorCommon(lngLat: number[]): [number, number];
/** Returns a Mercator viewport for bounds computation, bypassing GlobeView. */
export declare function getMercatorReferenceViewport(viewport: Viewport): Viewport;
