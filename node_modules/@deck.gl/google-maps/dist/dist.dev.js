...
var __exports__ = (() => {
  ...
  function warnDebugImportRequired() {
    if (!debugImportWarningShown) {
      ...
      import_core2.log.warn("Import @luma.gl/webgl/debug before enabling WebGL debugging.")();
    }
  }
  var import_core2, webglDeveloperToolsHooks, spectorHooks, debugImportWarningShown;
  ...
  var init_webgl_device_features = __esm({
    "../../node_modules/@luma.gl/webgl/dist/adapter/device-helpers/webgl-device-features.js"() {
      ...
      WEBGL_FEATURES = {
        ...
        "html-in-canvas": (gl) => (0, import_core4.isHTMLInCanvasSupported)() && typeof gl.texElementImage2D === "function",
...
Source: ${sourceLine}` : "";
  ...
  function readUniformBlocks(gl, program, options) {
    ...
    for (const [blockIndex, uniformBlock] of knownBlocksByIndex) {
      ...
      try {
        ...
        import_core15.log.once(0, `WebGL uniform block reflection failed for "${uniformBlock.name}"; using supplied std140 metadata. ${message2}`)();
      }
    }
  ...
  function readReflectedUniformBlock(gl, program, blockIndex, knownBlockName) {
    ...
    if (uniformInstancePrefixes.size === 1 && !uniformInstancePrefixes.has(blockInfo.name) && !uniformInstancePrefixes.has(blockAlias)) {
      ...
      import_core15.log.warn(`Uniform block "${blockInfo.name}" uses GLSL instance "${instanceName}". luma.gl binds uniform buffers by block name ("${blockInfo.name}") and alias ("${blockAlias}"). Prefer matching the instance name to one of those to avoid confusing silent mismatches.`)();
    }
    return blockInfo;
  }
  ...
  function makeUniformBlockBindingFromTypes(uniformBlockLayout) {
    const shaderBlockLayout = (0, import_core15.makeShaderBlockLayout)(uniformBlockLayout.uniformTypes, {
      layout: "std140"
    });
    ...
    "../../node_modules/@luma.gl/webgl/dist/adapter/resources/webgl-render-pass.js"() {
      ...
      WEBGLRenderPass = class extends import_core19.RenderPass {
        ...
        setBindings(bindings, _options) {
          ...
          this.bindings = (0, import_core19.flattenBindingsByGroup)((0, import_core19.normalizeBindingsByGroup)(this.pipeline.shaderLayout, bindings));
        ...
        draw(options) {
          ...
          if (pipeline.linkStatus !== "success") {
            import_core19.log.info(2, `RenderPipeline:${pipeline.id}.draw() aborted - waiting for shader linking`)();
            return false;
          }
          if (!pipeline._areTexturesRenderable(this.bindings)) {
            import_core19.log.info(2, `RenderPipeline:${pipeline.id}.draw() aborted - textures not yet loaded`)();
            return false;
          }
  ...
  var init_webgl_vertex_array = __esm({
    "../../node_modules/@luma.gl/webgl/dist/adapter/resources/webgl-vertex-array.js"() {
      ...
      init_webgl_vertex_formats();
      init_fill_array();
      WEBGLVertexArray = class _WEBGLVertexArray extends import_core21.VertexArray {
        get [Symbol.toStringTag]() {
          return "VertexArray";
        }
        device;
        ...
        constructor(device, props) {
          ...
          for (const attributeInfo of Object.values((0, import_core21.getAttributeInfosFromLayouts)(props.shaderLayout, props.bufferLayout))) {
  ...
  var init_webgl_device = __esm({
    "../../node_modules/@luma.gl/webgl/dist/adapter/webgl-device.js"() {
      ...
      init_with_parameters();
      init_webgl_extensions();
      WebGLDevice = class _WebGLDevice extends import_core26.Device {
