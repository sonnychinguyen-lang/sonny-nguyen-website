...
var __exports__ = (() => {
  ...
  // src/expression-eval/expression-eval.ts
  ...
  var _JSONConfiguration = class _JSONConfiguration {
    /**
    ...
    constructor(configuration) {
      ...
      this.config = { ..._JSONConfiguration.defaultProps };
    ...
    merge(configuration) {
      for (const key in configuration) {
        if (key in this.config) {
          ...
          this.config[key] = isObject2(this.config[key]) ? Object.assign(this.config[key], value) : value;
  ...
  _JSONConfiguration.defaultProps = {
    log: console,
    // eslint-disable-lin,
    typeKey: TYPE_KEY,
  ...
  var JSONConfiguration = _JSONConfiguration;
  ...
  function instantiateClass(type, props, configuration) {
    ...
    if (!Class && !Component) {
      const { log } = configuration.config;
      if (log) {
