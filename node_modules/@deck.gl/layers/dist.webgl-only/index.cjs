...
// dist/arc-layer/arc-layer.wgsl.js
var shaderWGSL = null;
...
var ArcLayer = class extends import_core.Layer {
  ...
  getShaders() {
    ...
    return super.getShaders({
      ...
      modules: [import_core.project32, import_core.color, import_core.picking, arcUniforms]
    });
  }
...
// dist/bitmap-layer/bitmap-layer.wgsl.js
...
var BitmapLayer = class extends import_core3.Layer {
  getShaders() {
    return super.getShaders({
      ...
      modules: [import_core3.color, import_core3.project32, import_core3.picking, bitmapUniforms]
    });
  }
  initializeState() {
    const attributeManager = this.getAttributeManager();
...
function unpackUVsFromRGB(color10) {
  const [u, v, fracUV] = color10;
...
var IconLayer = class extends import_core6.Layer {
  getShaders() {
    ...
    return super.getShaders({
      ...
      modules: [import_core6.project32, import_core6.color, import_core6.picking, iconUniforms]
    });
  }
  initializeState() {
    var _a, _b;
...
var LineLayer = class extends import_core7.Layer {
  ...
  getShaders() {
    ...
    return super.getShaders({
      ...
      source: shaderWGSL2,
      defines: antialiasing ? { ANTIALIASING: 1 } : {},
      modules: [import_core7.project32, import_core7.color, import_core7.picking, lineUniforms]
    });
  }
  // This layer has its own wrapLongitude logic
  get wrapLongitude() {
...
var ScatterplotLayer = class extends import_core10.Layer {
  getShaders() {
    ...
    return super.getShaders({
      ...
      defines: useRowIndexes ? { USE_ROW_INDEXES: true } : {},
      modules: [
        import_core10.project32,
        import_core10.color,
        import_core10.picking,
        scatterplotUniforms,
        ...[]
      ]
    });
...
// dist/column-layer/column-layer.wgsl.js
var getColumnLayerWGSL = () => null;
...
var ColumnLayer = class extends import_core12.Layer {
  getShaders() {
    ...
    return super.getShaders({
      ...
      defines,
      modules: [
        import_core12.project32,
        import_core12.color,
        flatShading ? import_core12.phongMaterial : import_core12.gouraudMaterial,
        import_core12.picking,
        columnUniforms
      ]
    });
  }
...
// dist/path-layer/path-layer.wgsl.js
var shaderWGSL4 = null;
...
var PathLayer = class extends import_core15.Layer {
  getShaders() {
    ...
    return super.getShaders({
      ...
      defines: antialiasing ? { ANTIALIASING: 1 } : {},
      modules: [
        import_core15.project32,
        import_core15.color,
        import_core15.picking,
        pathUniforms,
        ...[]
      ]
    });
  ...
  getPathProjectionScale(viewport) {
    ...
    const trackViewportScale = viewport instanceof import_core15.WebMercatorViewport && viewport.zoom >= 12 && // Offset coordinate systems use their fixed coordinateOrigin as the projection origin.
    ...
    if (trackViewportScale) {
      const projectUniforms = import_core15.project.getUniforms({
        viewport,
        coordinateSystem,
...
// dist/solid-polygon-layer/solid-polygon-layer.wgsl.js
var getSolidPolygonShaderWGSL = () => null;
...
var SolidPolygonLayer = class extends import_core17.Layer {
  getShaders(type) {
    ...
    return super.getShaders({
      ...
      modules: [
        import_core17.project32,
        import_core17.color,
        import_core17.gouraudMaterial,
        import_core17.picking,
  ...
  calculateVertexValid(attribute) {
    ...
    const vertexValid = false ? binaryVertexValid : this.state.polygonTesselator.get("vertexValid");
    attribute.value = false ? Float32Array.from(vertexValid) : vertexValid;
  }
...
// dist/text-layer/multi-icon-layer/multi-icon-layer.wgsl.js
var shaderWGSL5 = null;
...
// dist/text-layer/text-background-layer/text-background-layer.wgsl.js
...
var TextBackgroundLayer = class extends import_core22.Layer {
  getShaders() {
    return super.getShaders({
      ...
      modules: [import_core22.project32, import_core22.color, import_core22.picking, textBackgroundUniforms, textUniforms]
    });
  }
  initializeState() {
    this.getAttributeManager().addInstanced({
