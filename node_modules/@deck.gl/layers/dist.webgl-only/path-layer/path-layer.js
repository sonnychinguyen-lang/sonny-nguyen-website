...
import { shaderWGSL } from "./path-layer.wgsl.js";
import vs from "./path-layer-vertex.glsl.js";
import fs from "./path-layer-fragment.glsl.js";
import clipExtension from "../utils/clip-extension.js";
...
class PathLayer extends Layer {
    ...
    getPathProjectionScale(viewport) {
        ...
        const trackViewportScale = viewport instanceof WebMercatorViewport &&
            viewport.zoom >= 12 &&
    ...
    shouldUpdateState(params) {
        ...
        return (super.shouldUpdateState(params) ||
            ...
            !pathProjectionScalesEqual(this.state?.pathProjectionScale, this.getPathProjectionScale(viewport)));
    }
    initializeState() {
        const noAlloc = true;
    ...
    updateState(params) {
        ...
        const getPathChanged = changeFlags.updateTriggersChanged &&
            (changeFlags.updateTriggersChanged.all || changeFlags.updateTriggersChanged.getPath);
        const geometryConfigurationChanged = getPathChanged ||
