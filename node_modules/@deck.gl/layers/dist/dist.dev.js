...
var __exports__ = (() => {
  ...
  // bundle/index.ts
  __reExport(index_exports, peer_dependency_exports);
...
`;
  ...
  // src/arc-layer/arc-layer.wgsl.ts
  var shaderWGSL = (
    /* wgsl */
  ...
  var ArcLayer = class extends import_core2.Layer {
    ...
    getShaders() {
      ...
      return super.getShaders({
        ...
        modules: [import_core2.project32, import_core2.color, import_core2.picking, arcUniforms]
      });
    }
...
`;
  ...
  // src/bitmap-layer/bitmap-layer.wgsl.ts
  ...
  var BitmapLayer = class extends import_core4.Layer {
    getShaders() {
      return super.getShaders({
        ...
        modules: [import_core4.color, import_core4.project32, import_core4.picking, bitmapUniforms]
      });
    }
    initializeState() {
      const attributeManager = this.getAttributeManager();
  ...
  var IconLayer = class extends import_core7.Layer {
    getShaders() {
      ...
      return super.getShaders({
        ...
        modules: [import_core7.project32, import_core7.color, import_core7.picking, iconUniforms]
      });
    }
    initializeState() {
      this.state = {
  ...
  var LineLayer = class extends import_core8.Layer {
    ...
    getShaders() {
      ...
      return super.getShaders({
        ...
        source: shaderWGSL3,
        defines: antialiasing ? { ANTIALIASING: 1 } : {},
        modules: [import_core8.project32, import_core8.color, import_core8.picking, lineUniforms]
      });
    }
    // This layer has its own wrapLongitude logic
    get wrapLongitude() {
...
`
  ...
  function getShaderWGSL2(useRowIndexes) {
    return shaderWGSL5.replace("PICKING_COLOR_ATTRIBUTE", useRowIndexes ? "@location(8) rowIndexes: u32," : "").replace(
      "PICKING_COLOR_VALUE",
  ...
  var ScatterplotLayer = class extends import_core11.Layer {
    getShaders() {
      ...
      return super.getShaders({
        ...
        defines: useRowIndexes ? { USE_ROW_INDEXES: true } : {},
        modules: [
          import_core11.project32,
          import_core11.color,
          import_core11.picking,
          scatterplotUniforms,
...
`;
  ...
  // src/column-layer/column-layer.wgsl.ts
  var sharedSource = (
    /* wgsl */
    `struct Attributes {
  @builtin(instance_index) instanceIndex: u32,
  ...
  var ColumnLayer = class extends import_core13.Layer {
    getShaders() {
      ...
      return super.getShaders({
        ...
        defines,
        modules: [
          import_core13.project32,
          import_core13.color,
          flatShading ? import_core13.phongMaterial : import_core13.gouraudMaterial,
          import_core13.picking,
          columnUniforms
        ]
      });
    }
...
`;
  ...
  // src/path-layer/path-layer.wgsl.ts
  var shaderWGSL6 = (
    /* wgsl */
...
`;
  ...
  function getPathProjectionScale(viewport) {
    ...
    return [unitsPerMeter2[0], unitsPerMeter2[1], unitsPerMeter2[2]];
  }
  ...
  var PathLayer = class extends import_core16.Layer {
    getShaders() {
      ...
      return super.getShaders({
        ...
        defines: antialiasing ? { ANTIALIASING: 1 } : {},
        modules: [
          import_core16.project32,
          import_core16.color,
          import_core16.picking,
          pathUniforms,
          ...this.context.device.type === "webgpu" ? [clip_extension_default] : []
        ]
      });
    ...
    getPathProjectionScale(viewport) {
      ...
      const trackViewportScale = viewport instanceof import_core16.WebMercatorViewport && viewport.zoom >= 12 && // Offset coordinate systems use their fixed coordinateOrigin as the projection origin.
      ...
      if (trackViewportScale) {
        const projectUniforms = import_core16.project.getUniforms({
          viewport,
          coordinateSystem,
    ...
    shouldUpdateState(params) {
      ...
      return super.shouldUpdateState(params) || this.state?.tessellationResolution !== viewport.resolution || !pathProjectionScalesEqual(
...
`;
  ...
  // src/solid-polygon-layer/solid-polygon-layer.wgsl.ts
  ...
  var SolidPolygonLayer = class extends import_core18.Layer {
    getShaders(type) {
      ...
      return super.getShaders({
        ...
        modules: [
          import_core18.project32,
          import_core18.color,
          import_core18.gouraudMaterial,
          import_core18.picking,
    ...
    calculateNextPositions(attribute) {
      ...
      const vertexValid = this.props.data.attributes?.instanceVertexValid?.value || attributes.vertexValid?.value || polygonTesselator.get("vertexValid");
      attribute.startIndices = polygonTesselator.vertexStarts;
      if (!positions) {
        attribute.value = positions;
        return;
...
`;
  ...
  // src/text-layer/multi-icon-layer/multi-icon-layer.wgsl.ts
...
`;
  ...
  // src/text-layer/text-background-layer/text-background-layer.wgsl.ts
  ...
  var TextBackgroundLayer = class extends import_core23.Layer {
    getShaders() {
      return super.getShaders({
        ...
        modules: [import_core23.project32, import_core23.color, import_core23.picking, textBackgroundUniforms, textUniforms]
      });
    }
    initializeState() {
      this.getAttributeManager().addInstanced({
