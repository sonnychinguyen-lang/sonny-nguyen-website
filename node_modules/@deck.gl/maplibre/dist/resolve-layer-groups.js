...
import MapLibreLayerGroup from "./layer-group.js";
import { getMapLibreLayerGroupId } from "./layer-utils.js";
const LAYER_GROUPS = new WeakMap();
// eslint-disable-next-line complexity, max-statements
export function resolveMapLibreLayerGroups(map, oldLayers, newLayers) {
    ...
    if (oldLayers !== newLayers) {
        const previousLayers = flatten(oldLayers, Boolean);
