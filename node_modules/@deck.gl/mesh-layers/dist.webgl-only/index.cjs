...
var SimpleMeshLayer = class extends import_core2.Layer {
  getShaders() {
    return super.getShaders({
      ...
      modules: [import_core2.project32, import_core2.color, import_core2.phongMaterial, import_core2.picking, simpleMeshUniforms]
    });
  }
  getBounds() {
    var _a;
...
var source = import_shadertools.pbrMaterial.source.replace(/fn pbr_setPositionNormalTangentUV\([\s\S]*?\n}\n/, `fn pbr_setPositionNormalTangentUV(position: vec4f, normal: vec4f, tangent: vec4f, uv: vec2f)
{
...
var scenegraphPbrMaterial = {
  ...
  dependencies: [import_shadertools.lighting],
  source
};
...
var ScenegraphLayer = class extends import_core4.Layer {
  getShaders() {
    ...
    if (this.props._lighting === "pbr") {
      pbr = isWebGPU ? scenegraphPbrMaterial : import_shadertools2.pbrMaterial;
    ...
    const modules = [import_core4.project32, import_core4.color, import_core4.picking, scenegraphUniforms, pbr];
