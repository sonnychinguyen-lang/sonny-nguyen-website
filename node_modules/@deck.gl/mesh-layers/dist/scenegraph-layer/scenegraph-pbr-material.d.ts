import type { PBRMaterialProps, PBRMaterialUniforms } from '@luma.gl/shadertools';
export declare const scenegraphPbrMaterial: {
    readonly dependencies: [{
        readonly props: import("@luma.gl/shadertools").LightingProps;
        readonly uniforms: import("@luma.gl/shadertools").LightingUniforms;
        ...
        readonly defaultUniforms: import("@luma.gl/shadertools").LightingUniforms;
        ...
        readonly getUniforms: (props?: import("@luma.gl/shadertools").LightingProps, _prevUniforms?: Partial<import("@luma.gl/shadertools").LightingUniforms>) => import("@luma.gl/shadertools").LightingUniforms;
    }];
    ...
    readonly bindingLayout: readonly [{
        ...
        readonly name: "pbr_bumpSampler";
        readonly group: 3;
    }, {
        readonly name: "pbr_diffuseTransmissionSampler";
        readonly group: 3;
    }, {
        readonly name: "pbr_diffuseTransmissionColorSampler";
        readonly group: 3;
    }, {
        readonly name: "pbr_multiscatterColorSampler";
        readonly group: 3;
    }];
    ...
    readonly defines: {
        ...
        readonly HAS_BUMPMAP: false;
        readonly HAS_DIFFUSETRANSMISSIONMAP: false;
        readonly HAS_DIFFUSETRANSMISSIONCOLORMAP: false;
        readonly HAS_MULTISCATTERCOLORMAP: false;
    ...
    readonly uniformTypes: {
        ...
        readonly bumpFactor: "f32";
        readonly bumpMapEnabled: "i32";
        readonly diffuseTransmissionFactor: "f32";
        readonly diffuseTransmissionMapEnabled: "i32";
        readonly diffuseTransmissionColorFactor: "vec3<f32>";
        readonly diffuseTransmissionColorMapEnabled: "i32";
        readonly multiscatterColorFactor: "vec3<f32>";
        readonly multiscatterColorMapEnabled: "i32";
        readonly scatterAnisotropy: "f32";
        readonly bumpUVSet: "i32";
        readonly bumpUVTransform: "mat3x3<f32>";
        readonly diffuseTransmissionUVSet: "i32";
        readonly diffuseTransmissionUVTransform: "mat3x3<f32>";
        readonly diffuseTransmissionColorUVSet: "i32";
        readonly diffuseTransmissionColorUVTransform: "mat3x3<f32>";
        readonly multiscatterColorUVSet: "i32";
        readonly multiscatterColorUVTransform: "mat3x3<f32>";
    };
};
//# sourceMappingURL=scenegraph-pbr-material.d.ts.map