...
export class CompassWidget extends Widget {
    ...
    onRenderHTML(rootElement) {
        ...
        const tooltipContent = this.props.tooltip === false ? undefined : (this.props.tooltip ?? this.props.label);
        const ui = (_jsx("div", { className: "deck-widget-button", style: { perspective: 100 }, children: _jsx(Tooltip, { content: tooltipContent, children: _jsx("button", { type: "button", onClick: () => {
                        for (const viewport of Object.values(this.viewports)) {
                            this.handleCompassReset(viewport);
                        }
                    }, "aria-label": this.props.label, style: { transform: `rotateX(${rx}deg)` }, children: _jsx("svg", { fill: "none", width: "100%", height: "100%", viewBox: "0 0 26 26", children: _jsxs("g", { transform: `rotate(${rz},13,13)`, children: [_jsx("path", { d: "M10 13.0001L12.9999 5L15.9997 13.0001H10Z", fill: "var(--icon-compass-north-color, rgb(240, 92, 68))" }), _jsx("path", { d: "M16.0002 12.9999L13.0004 21L10.0005 12.9999H16.0002Z", fill: "var(--icon-compass-south-color, rgb(204, 204, 204))" })] }) }) }) }) }));
