...
var __exports__ = (() => {
  ...
  function _(l3, u4, t3) {
    var i3, o3, r3, f4 = {};
    for (r3 in u4) "key" == r3 ? i3 = u4[r3] : "ref" == r3 ? o3 = u4[r3] : f4[r3] = u4[r3];
  ...
  function g(n2, t3, i3, o3, r3) {
    var f4 = { type: n2, props: t3, key: i3, ref: o3, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, constructor: void 0, __v: null == r3 ? ++u : r3, __i: -1, __u: 0 };
  ...
  function S(n2, l3, u4, t3, i3, o3, r3, f4, e3, c3, s3) {
    var a3, v3, y3, d3, w3, _3 = t3 && t3.__k || p, g2 = l3.length;
    for (u4.__d = e3, $(u4, l3, _3), e3 = u4.__d, a3 = 0; a3 < g2; a3++) null != (y3 = u4.__k[a3]) && "boolean" != typeof y3 && "function" != typeof y3 && (v3 = -1 === y3.__i ? h : _3[y3.__i] || h, y3.__i = a3, O(n2, y3, v3, i3, o3, r3, f4, e3, c3, s3), d3 = y3.__e, y3.ref && v3.ref != y3.ref && (v3.ref && N(v3.ref, null, y3), s3.push(y3.ref, y3.__c || d3, y3)), null == w3 && null != d3 && (w3 = d3), 65536 & y3.__u || v3.__k === y3.__k ? e3 = I(y3, e3, n2) : "function" == typeof y3.type && void 0 !== y3.__d ? e3 = y3.__d : d3 && (e3 = d3.nextSibling), y3.__d = void 0, y3.__u &= -196609);
    u4.__d = e3, u4.__e = w3;
  }
  function $(n2, l3, u4) {
    var t3, i3, o3, r3, f4, e3 = l3.length, c3 = u4.length, s3 = c3, a3 = 0;
    for (n2.__k = [], t3 = 0; t3 < e3; t3++) r3 = t3 + a3, null != (i3 = n2.__k[t3] = null == (i3 = l3[t3]) || "boolean" == typeof i3 || "function" == typeof i3 ? null : "string" == typeof i3 || "number" == typeof i3 || "bigint" == typeof i3 || i3.constructor == String ? g(null, i3, null, null, null) : y(i3) ? g(k, { children: i3 }, null, null, null) : void 0 === i3.constructor && i3.__b > 0 ? g(i3.type, i3.props, i3.key, i3.ref ? i3.ref : null, i3.__v) : i3) ? (i3.__ = n2, i3.__b = n2.__b + 1, f4 = L(i3, u4, r3, s3), i3.__i = f4, o3 = null, -1 !== f4 && (s3--, (o3 = u4[f4]) && (o3.__u |= 131072)), null == o3 || null === o3.__v ? (-1 == f4 && a3--, "function" != typeof i3.type && (i3.__u |= 65536)) : f4 !== r3 && (f4 == r3 - 1 ? a3-- : f4 == r3 + 1 ? a3++ : f4 > r3 ? s3 > e3 - r3 ? a3 += f4 - r3 : a3-- : f4 < r3 && (f4 == r3 - a3 ? a3 -= f4 - r3 : a3++), f4 !== t3 + a3 && (i3.__u |= 65536))) : (o3 = u4[r3]) && null == o3.key && o3.__e && 0 == (131072 & o3.__u) && (o3.__e == n2.__d && (n2.__d = x(o3)), V(o3, o3, false), u4[r3] = null, s3--);
  ...
  function L(n2, l3, u4, t3) {
    var i3 = n2.key, o3 = n2.type, r3 = u4 - 1, f4 = u4 + 1, e3 = l3[u4];
  ...
  function O(n2, u4, t3, i3, o3, r3, f4, e3, c3, s3) {
    var a3, h3, p3, v3, w3, _3, g2, m2, x2, C3, M2, P2, $2, I2, H, L2, T3 = u4.type;
    if (void 0 !== u4.constructor) return null;
    128 & t3.__u && (c3 = !!(32 & t3.__u), r3 = [e3 = u4.__e = t3.__e]), (a3 = l.__b) && a3(u4);
    n: if ("function" == typeof T3) try {
      if (m2 = u4.props, x2 = "prototype" in T3 && T3.prototype.render, C3 = (a3 = T3.contextType) && i3[a3.__c], M2 = a3 ? C3 ? C3.props.value : a3.__ : i3, t3.__c ? g2 = (h3 = u4.__c = t3.__c).__ = h3.__E : (x2 ? u4.__c = h3 = new T3(m2, M2) : (u4.__c = h3 = new b(m2, M2), h3.constructor = T3, h3.render = q), C3 && C3.sub(h3), h3.props = m2, h3.state || (h3.state = {}), h3.context = M2, h3.__n = i3, p3 = h3.__d = true, h3.__h = [], h3._sb = []), x2 && null == h3.__s && (h3.__s = h3.state), x2 && null != T3.getDerivedStateFromProps && (h3.__s == h3.state && (h3.__s = d({}, h3.__s)), d(h3.__s, T3.getDerivedStateFromProps(m2, h3.__s))), v3 = h3.props, w3 = h3.state, h3.__v = u4, p3) x2 && null == T3.getDerivedStateFromProps && null != h3.componentWillMount && h3.componentWillMount(), x2 && null != h3.componentDidMount && h3.__h.push(h3.componentDidMount);
      else {
        if (x2 && null == T3.getDerivedStateFromProps && m2 !== v3 && null != h3.componentWillReceiveProps && h3.componentWillReceiveProps(m2, M2), !h3.__e && (null != h3.shouldComponentUpdate && false === h3.shouldComponentUpdate(m2, h3.__s, M2) || u4.__v === t3.__v)) {
      ...
      h3.state = h3.__s, null != h3.getChildContext && (i3 = d(d({}, i3), h3.getChildContext())), x2 && !p3 && null != h3.getSnapshotBeforeUpdate && (_3 = h3.getSnapshotBeforeUpdate(v3, w3)), S(n2, y(L2 = null != a3 && a3.type === k && null == a3.key ? a3.props.children : a3) ? L2 : [L2], u4, t3, i3, o3, r3, f4, e3, c3, s3), h3.base = u4.__e, u4.__u &= -161, h3.__h.length && f4.push(h3), g2 && (h3.__E = h3.__ = null);
    } catch (n3) {
    ...
    else null == r3 && u4.__v === t3.__v ? (u4.__k = t3.__k, u4.__e = t3.__e) : u4.__e = z(t3.__e, u4, t3, i3, o3, r3, f4, c3, s3);
    (a3 = l.diffed) && a3(u4);
  }
  function j(n2, u4, t3) {
    u4.__d = void 0;
  ...
  function z(l3, u4, t3, i3, o3, r3, f4, e3, c3) {
    ...
    if (null === b2) m2 === k3 || e3 && l3.data === k3 || (l3.data = k3);
      ...
      else if (p3 && (l3.innerHTML = ""), S(l3, y(v3) ? v3 : [v3], u4, t3, i3, "foreignObject" === b2 ? "http://www.w3.org/1999/xhtml" : o3, r3, f4, r3 ? r3[0] : t3.__k && x(t3, 0), e3, c3), null != r3) for (s3 = r3.length; s3--; ) null != r3[s3] && w(r3[s3]);
  ...
  function B(u4, t3, i3) {
    var o3, r3, f4, e3;
    l.__ && l.__(u4, t3), r3 = (o3 = "function" == typeof i3) ? null : i3 && i3.__k || t3.__k, f4 = [], e3 = [], O(t3, u4 = (!o3 && i3 || t3).__k = _(k, null, [u4]), r3 || h, h, t3.namespaceURI, !o3 && i3 ? [i3] : r3 ? null : t3.firstChild ? n.call(t3.childNodes) : null, f4, !o3 && i3 ? i3 : r3 ? r3.__e : t3.firstChild, o3, e3), j(f4, u4, e3);
  }
  ...
  function u2(e3, t3, n2, o3, i3, u4) {
    ...
    var l3 = { type: e3, props: p3, key: n2, ref: a3, __k: null, __: null, __b: 0, __e: null, __d: void 0, __c: null, constructor: void 0, __v: --f2, __i: -1, __u: 0, __source: i3, __self: u4 };
  ...
  var Tooltip = ({ content, placement = "right", children }) => {
    ...
    y2(() => {
      ...
      if (!visible || !tooltip || !trigger) return void 0;
      const updatePosition = () => {
        computePosition2(trigger, tooltip, {
          placement,
          strategy: "fixed",
          middleware: [offset2(8), flip2(), shift2({ padding: 4 })]
        }).then(({ x: x2, y: y3 }) => {
          if (tooltipRef.current === tooltip) {
            Object.assign(tooltip.style, { left: `${x2}px`, top: `${y3}px`, opacity: "1" });
          }
        });
      };
    ...
    const renderContent = () => {
      if (content instanceof HTMLElement) {
        return /* @__PURE__ */ u2("div", { ref: htmlRef });
      }
      return content;
    };
  ...
  var IconButton = (props) => {
    ...
    const tooltipContent = tooltip === false ? void 0 : tooltip ?? label;
    const iconStyle = T2(() => {
    ...
    const button = /* @__PURE__ */ u2(
      "button",
      {
        ...
        onClick,
        "aria-label": label,
        children: children ? children : /* @__PURE__ */ u2("div", { className: "deck-widget-icon", style: iconStyle })
      }
    );
    return /* @__PURE__ */ u2("div", { className: "deck-widget-button", style, children: tooltipContent ? /* @__PURE__ */ u2(Tooltip, { content: tooltipContent, children: button }) : button });
  };

  // src/zoom-widget.tsx
  var ZoomWidget = class extends import_core3.Widget {
    constructor(props = {}) {
      super(props);
    ...
    isOrthographicView(viewId) {
      ...
      return view instanceof import_core3.OrthographicView;
    }
    handleZoom(viewId, delta) {
      ...
      if (this.isOrthographicView(viewId)) {
        ...
        let nextZoomY;
        if (zoomAxis === "X") {
          nextZoom = clamp2(zoomX + delta, minZoomX, maxZoomX);
          nextZoomY = zoomY;
        } else if (zoomAxis === "Y") {
          nextZoom = zoomX;
          nextZoomY = clamp2(zoomY + delta, minZoomY, maxZoomY);
        } else {
          const clampedDelta = clamp2(
            delta,
        ...
        const nextZoom = clamp2(zoom + delta, minZoom, maxZoom);
  ...
  ZoomWidget.defaultProps = {
    ...
    zoomInTooltip: void 0,
    zoomOutTooltip: void 0,
    zoomAxis: "all",
    viewId: null,
    onZoom: () => {
    }
  };
  function clamp2(zoom, minZoom, maxZoom) {
  ...
  var ResetViewWidget = class extends import_core4.Widget {
    constructor(props = {}) {
      super(props);
  ...
  var GimbalWidget = class extends import_core5.Widget {
    constructor(props = {}) {
      super(props);
    ...
    onRenderHTML(rootElement) {
      ...
      const tooltipContent = this.props.tooltip === false ? void 0 : this.props.tooltip ?? this.props.label;
      const ui = /* @__PURE__ */ u2("div", { className: "deck-widget-button", style: { perspective: 100, pointerEvents: "auto" }, children: /* @__PURE__ */ u2(Tooltip, { content: tooltipContent, children: /* @__PURE__ */ u2(
        "button",
        {
          type: "button",
          onClick: () => {
    ...
    resetOrbitView(viewport) {
      ...
      if ("rotationOrbit" in viewState || "rotationX" in viewState) {
        ...
        const nextViewState = {
          ...
          rotationX: 0,
          transitionDuration: this.props.transitionDuration,
          transitionInterpolator: new import_core5.LinearInterpolator({
  ...
  var CompassWidget = class extends import_core6.Widget {
    constructor(props = {}) {
      super(props);
    ...
    onRenderHTML(rootElement) {
      ...
      const tooltipContent = this.props.tooltip === false ? void 0 : this.props.tooltip ?? this.props.label;
      const ui = /* @__PURE__ */ u2("div", { className: "deck-widget-button", style: { perspective: 100 }, children: /* @__PURE__ */ u2(Tooltip, { content: tooltipContent, children: /* @__PURE__ */ u2(
        "button",
        {
          type: "button",
          onClick: () => {
    ...
    getRotation(viewport) {
      if (viewport instanceof import_core6.WebMercatorViewport) {
        return [-viewport.bearing, viewport.pitch];
      } else if (viewport instanceof import_core6._GlobeViewport) {
    ...
    handleCompassReset(viewport) {
      ...
      if (viewport instanceof import_core6.WebMercatorViewport) {
        ...
        const nextViewState = {
          ...
          transitionDuration: this.props.transitionDuration,
          transitionInterpolator: new import_core6.FlyToInterpolator()
        };
        this.setViewState(viewId, nextViewState);
      }
    }
  ...
  var ScaleWidget = class extends import_core7.Widget {
    constructor(props = {}) {
      super(props);
  ...
  var DropdownMenu = (props) => {
    ...
    return /* @__PURE__ */ u2(
      SimpleMenu,
      {
        ...
        trigger: /* @__PURE__ */ u2("button", { className: "deck-widget-dropdown-button", onClick: () => setIsOpen(!isOpen), children: /* @__PURE__ */ u2("span", { className: `deck-widget-dropdown-icon ${isOpen ? "open" : ""}` }) })
      }
    );
  };
  var SimpleMenu = (props) => {
    ...
    return /* @__PURE__ */ u2("div", { className: "deck-widget-dropdown-container", ref: dropdownRef, children: [
      props.trigger,
      props.isOpen && /* @__PURE__ */ u2("ul", { className: "deck-widget-dropdown-menu", style: props.style, children: props.menuItems.map((item, i3) => {
        ...
        return /* @__PURE__ */ u2(
          "li",
          {
            ...
            children: [
              icon && /* @__PURE__ */ u2("span", { className: "deck-widget-dropdown-item-icon", style: getCSSMask(icon) }),
  ...
  var GeocoderWidget = class extends import_core8.Widget {
    constructor(props = {}) {
      super(props);
    ...
    flyTo(viewState) {
      for (const viewId of this.viewIds) {
        ...
        if (this.props.transitionDuration > 0) {
          nextViewState.transitionDuration = this.props.transitionDuration;
          nextViewState.transitionInterpolator = "latitude" in nextViewState ? new import_core9.FlyToInterpolator() : new import_core9.LinearInterpolator();
        }
        this.setViewState(viewId, nextViewState);
      }
    }
  ...
  var FullscreenWidget = class extends import_core10.Widget {
    constructor(props = {}) {
      super(props);
    ...
    onRenderHTML(rootElement) {
      ...
      B(
        /* @__PURE__ */ u2(
          ...
          {
            onClick: () => {
              this.handleClick().catch((err) => import_core10.log.error(err)());
            },
  ...
  // src/view-layout/view-layout.ts
  var import_core11 = __toESM(require_core(), 1);
  var VIEW_LAYOUT_TYPES = /* @__PURE__ */ new Set(["row", "column", "overlay", "spacer"]);
  var VIEW_LAYOUT_ORIENTATIONS = /* @__PURE__ */ new Set(["horizontal", "vertical"]);
  function isViewLayout(child) {
    return Boolean(
      child && typeof child === "object" && !(child instanceof import_core11.View) && ("type" in child && VIEW_LAYOUT_TYPES.has(String(child.type)) || "orientation" in child && VIEW_LAYOUT_ORIENTATIONS.has(String(child.orientation)))
    );
  }
  function getViewLayoutType(item) {
    if ("orientation" in item) {
      return item.orientation === "horizontal" ? "row" : "column";
    }
    return item.type;
  }
  function getViewLayoutChildren(item) {
    return "views" in item ? item.views : item.children;
  }
  function assertViewLayout(item) {
  ...
  function assertViewLayoutChild(child) {
    ...
    if (child instanceof import_core11.View) {
      return;
    }
    throw new Error("ViewLayout children must be deck.gl View instances or layout objects.");
  }

  // src/view-layout/build-views-from-view-layout.ts
  function buildViewsFromViewLayout(args) {
    ...
    const previousViewsById = new Map(
      (args.previous?.views ?? []).map((view) => [getViewId(view), view]).filter((entry) => Boolean(entry[0]))
    );
    const outputViews = [];
    const rectsById = {};
    const splittersById = {};
    ...
    switch (type) {
      case "row":
        compileStackLayout({
          ...
          item,
          orientation: "row",
          children: getViewLayoutChildren(item)
        });
        return;
      case "column":
        compileStackLayout({
  ...
  function compileOverlayLayout(args) {
    const containerRect = applyInsets(args.rect, args.item.inset);
    args.children.filter(isPresentChild).forEach(
      (child) => compileLayoutChild({
        child,
        rect: containerRect,
        rootRect: args.rootRect,
        outputViews: args.outputViews,
  ...
  function getStackAxisConfig(args) {
    const constraints = args.children.map(
      (child) => getStackChildAxisConstraints(child, args.orientation, args.containerAxisLength)
    );
  ...
  function getSplitStackAxisConfig(args) {
    ...
    for (let index = 0; index < boundaries.length; index++) {
      ...
      const desiredSplit = args.splitValues[splitId] ?? (args.children.length === 2 ? args.item.initialSplit : void 0) ?? boundaries[index];
  ...
  function getDefaultSplitBoundaries(args) {
    ...
    if (totalLength <= 0) {
      return args.children.slice(1).map((_3, index) => (index + 1) / args.children.length);
    }
    let cursor = 0;
  ...
  function getSplitBoundaryLimits(args) {
    ...
    const leftMaxSplit = Number.isFinite(leftConstraints.maxPixels) ? previousSplit + leftConstraints.maxPixels / args.axisLength : 1;
    const rightMaxSplit = Number.isFinite(rightConstraints.maxPixels) ? nextSplit - rightConstraints.maxPixels / args.axisLength : 0;
  ...
  function getSplitId(splitId, childCount, index) {
    return childCount === 2 ? splitId : `${splitId}-${index}`;
  }
  function getStackAxisLengthsFromBoundaries(containerAxisLength, boundaries) {
  ...
  function getConstrainedStackChildAxisLengths(containerAxisLength, constraints) {
    const { childAxisLengths, flexibleChildIndexes, fixedLength } = getInitialStackChildAxisLengths(constraints);
  ...
  function getInitialStackChildAxisLengths(constraints) {
    const childAxisLengths = constraints.map(({ explicitLength }) => explicitLength);
    const flexibleChildIndexes = [];
    let fixedLength = 0;
  ...
  function getStackChildAxisConstraints(child, orientation, parentAxisLength) {
  ...
  function resolveViewRectWithinParent(view, parentRect, overrides) {
    const props = { ...view.props, ...overrides };
    const x2 = parentRect.x + resolveOffset(props.x, parentRect.width);
    const y3 = parentRect.y + resolveOffset(props.y, parentRect.height);
  ...
  function getPixelConstraintValue(child, propName) {
    const value = isViewLayout(child) ? child[propName] : child.props[propName];
  ...
  function adaptViewLayout(root) {
    const layoutsById = [];
    const isViewLayout2 = (v3) => "views" in v3;
    function adaptLayout(l3) {
      ...
      const childEntries = l3.views.map((view) => {
        if (!isViewLayout2(view)) {
  ...
  var SplitterWidget = class extends import_core12.Widget {
    constructor(props) {
      super(props);
    ...
    setProps(props) {
      if (props.viewLayout && !(0, import_core12._deepEqual)(props.viewLayout, this.props.viewLayout, -1)) {
    ...
    onRenderHTML(rootElement) {
      B(
        /* @__PURE__ */ u2(k, { children: this.viewLayouts.map(
          (layout) => layout.editable && /* @__PURE__ */ u2(
            Splitter,
            {
              ...layout,
  ...
  var Popover = ({
    ...
    updaterRef.current = () => {
      ...
      if (arrowRef.current) middleware.push(arrow2({ element: arrowRef.current }));
    ...
    return /* @__PURE__ */ u2("div", { style: { position: "absolute", left: x2, top: y3 }, ref: anchorRef, children: /* @__PURE__ */ u2(
      "div",
      {
  ...
  // src/lib/components/user-content.tsx
  var UserContent = ({ text, html, element, ...props }) => {
    ...
    return /* @__PURE__ */ u2("div", { ref: containerRef, ...props, dangerouslySetInnerHTML: html ? { __html: html } : void 0, children: text });
  };

  // src/info-widget.tsx
  var InfoWidget = class extends import_core13.Widget {
    constructor(props) {
      super(props);
  ...
  // src/popup-widget.tsx
  var import_core14 = __toESM(require_core(), 1);
  var PopupWidget = class extends import_core14.Widget {
    constructor(props) {
      super(props);
    ...
    onRenderHTML(rootElement) {
      ...
      const ui = /* @__PURE__ */ u2("div", { children: [
        marker && /* @__PURE__ */ u2("div", { className: "deck-widget-popup-marker", style: { left: x2, top: y3 }, children: /* @__PURE__ */ u2(UserContent, { ...marker, onClick: () => this._setIsOpen(true) }) }),
        this.isOpen && /* @__PURE__ */ u2(
          Popover,
          {
            x: x2,
            y: y3,
            ...
            children: /* @__PURE__ */ u2(
              "div",
              {
                ...
                style,
                children: [
                  this.props.closeButton && /* @__PURE__ */ u2(
                    "div",
                    {
                  ...
                  /* @__PURE__ */ u2(UserContent, { ...typeof content === "string" ? { text: content } : content })
                ]
              }
            )
          }
  ...
  var ContextMenuWidget = class extends import_core15.Widget {
    constructor(props) {
      super(props);
    ...
    handleContextMenu(srcEvent) {
      ...
      const pickInfo = this.deck?.pickObject({ x: x2, y: y3 }) || {
        x: x2,
        y: y3,
        picked: false,
        layer: null,
  ...
  // src/scrollbar-widget.tsx
  var import_core16 = __toESM(require_core(), 1);

  // src/lib/components/range-input.tsx
  ...
  function RangeInput(props) {
    ...
    const [trackLength, setTrackLength] = h2(0);
    ...
    const handleThumbPointerMove = q2(
      (event) => {
    ...
    const decorationElements = T2(() => {
      ...
      return decorations.map((decoration, index) => {
        ...
        return /* @__PURE__ */ u2("div", { className: "deck-widget-range__decoration", style, children: decoration.element }, `decoration-${index}`);
      });
    ...
    return /* @__PURE__ */ u2(
      "div",
      {
        ...
        children: [
          stepButtons && /* @__PURE__ */ u2(
            "button",
            {
              type: "button",
              className: "deck-widget-range__button deck-widget-range__button--start",
              "aria-label": startButtonAriaLabel,
              disabled: clampedStart <= min2,
              onClick: handleStepNegative,
              children: /* @__PURE__ */ u2("span", { className: "deck-widget-icon" })
            }
          ),
          /* @__PURE__ */ u2("div", { className: "deck-widget-range__track", ref: trackRef, onClick: handleTrackClick, children: [
            /* @__PURE__ */ u2("div", { className: "deck-widget-range__decorations", children: decorationElements }),
            /* @__PURE__ */ u2(
              "div",
              {
                ...
                ref: thumbRef,
                style: vertical ? { height: `${thumbLength * 100}%`, top: `${thumbOffset * 100}%` } : { width: `${thumbLength * 100}%`, left: `${thumbOffset * 100}%` },
          ...
          stepButtons && /* @__PURE__ */ u2(
            "button",
            {
              ...
              disabled: clampedStart >= min2 + maxStart,
  ...
  var _ScrollbarWidget = class _ScrollbarWidget extends import_core16.Widget {
    constructor(props) {
      const resolved = {
    ...
    getContentBoundsPadding(viewId) {
      return this.props.contentBoundsPadding ?? this.deck?.getView(viewId)?.controller?.maxBoundsPadding ?? null;
    }
    updateViewport(viewport) {
      ...
      const contentRect = (0, import_core16._getMaxBoundsRect)(
        viewport.width,
        viewport.height,
    ...
    getDecorations(viewport) {
      ...
      return decorations.map((decoration) => {
        ...
        const onClick = decoration.onClick ? (e3) => {
          const handled = decoration.onClick?.(e3);
          if (handled) {
            e3.stopPropagation();
            e3.preventDefault();
          }
  ...
  var ScrollbarWidget = _ScrollbarWidget;
  function projectBounds(bounds, viewport, isVertical) {
    return bounds.map(([x2, y3]) => viewport.project([x2, y3, 0])).reduce(
      (range, [x2, y3]) => {
  ...
  var IconWidget = class extends import_core17.Widget {
    constructor(props) {
      super(props);
      this.className = "";
      this.placement = "top-left";
  ...
  // src/toggle-widget.tsx
  var import_core18 = __toESM(require_core(), 1);
  var ToggleWidget = class extends import_core18.Widget {
    constructor(props) {
      super(props);
  ...
  // src/selector-widget.tsx
  var import_core19 = __toESM(require_core(), 1);
  var SelectorWidget = class extends import_core19.Widget {
    constructor(props) {
      super(props);
    ...
    onRenderHTML(rootElement) {
      ...
      B(
        /* @__PURE__ */ u2("div", { children: [
          ...
          this.isOpen && /* @__PURE__ */ u2(Popover, { ...this.isOpen, children: /* @__PURE__ */ u2(
            SimpleMenu,
            {
              isOpen: true,
  ...
  var TimelineWidget = class extends import_core20.Widget {
    constructor(props = {}) {
      super(props);
      this.id = "timeline";
    ...
    onRenderHTML(rootElement) {
      ...
      B(
        /* @__PURE__ */ u2("div", { className: "deck-widget-button-group", children: [
          isPlaying ? /* @__PURE__ */ u2(
            IconButton,
            {
              label: "Pause",
              ...
              decorations: [
                {
                  ...
                  element: /* @__PURE__ */ u2("div", { className: "deck-widget-timeline-label deck-widget-timeline-label--current", children: formatLabel(currentTime) })
                }
              ]
            }
          )
    ...
    play() {
      ...
      if (this.props.time === void 0 && this.getTime() >= max2) {
        ...
        this.props.timeline?.setTime(min2);
      }
      this.updateHTML();
      this.tick();
    }
  ...
  var ScreenshotWidget = class extends import_core21.Widget {
    constructor(props = {}) {
      super(props);
  ...
  ScreenshotWidget.defaultProps = {
    ...import_core21.Widget.defaultProps,
    id: "screenshot",
    placement: "top-left",
    viewId: null,
    label: "Screenshot",
  ...
  // src/theme-widget.tsx
  var ThemeWidget = class extends import_core23.Widget {
    constructor(props = {}) {
      super(props);
    ...
    _applyTheme(themeMode, rootElement) {
      ...
      if ((0, import_core22._deepEqual)(themeStyle, this.appliedTheme, 1)) {
        return;
      }
      const container = rootElement.closest(".deck-widget-container");
      if (!container) return;
      (0, import_core22._applyStyles)(container, themeStyle);
      this.appliedTheme = themeStyle;
      const label = themeMode === "dark" ? this.props.darkModeLabel : this.props.lightModeLabel;
      import_core22.log.log(1, `Switched theme to ${label}`, themeStyle)();
    }
  ...
  ThemeWidget.defaultProps = {
    ...import_core23.Widget.defaultProps,
    id: "theme",
    placement: "top-left",
    viewId: null,
    lightModeLabel: "Light Mode",
    lightModeTooltip: void 0,
    lightModeTheme: LightGlassTheme,
    darkModeLabel: "Dark Mode",
    darkModeTooltip: void 0,
  ...
  var LoadingWidget = class extends import_core24.Widget {
    constructor(props = {}) {
      super(props);
  ...
  LoadingWidget.defaultProps = {
    ...import_core24.Widget.defaultProps,
    id: "loading",
    placement: "top-left",
    viewId: null,
  ...
  var import_core26 = __toESM(require_core2(), 1);
  ...
  var StatsWidget = class extends import_core25.Widget {
    constructor(props = {}) {
      super(props);
    ...
    onRenderHTML(rootElement) {
      ...
      if (!isExpanded) {
        B(/* @__PURE__ */ u2(FpsIcon, { getFps: this._getFps, onClick: this._toggleExpanded }), rootElement);
        return;
      }
      ...
      if (stats) {
        stats.forEach((stat) => {
          ...
          lines.forEach((line, i3) => {
            items.push(
              /* @__PURE__ */ u2("div", { style: { whiteSpace: "pre" }, children: line }, `${stat.name}-${i3}`)
            );
          });
        });
      }
        ...
        /* @__PURE__ */ u2("div", { className: "deck-widget-stats-container", style: { cursor: "default" }, children: [
          /* @__PURE__ */ u2(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ u2("b", { children: title }),
                deviceLabel && /* @__PURE__ */ u2("span", { className: "deck-widget-stats-device", children: deviceLabel }),
                /* @__PURE__ */ u2("button", { className: "deck-widget-dropdown-button", children: /* @__PURE__ */ u2("span", { className: "deck-widget-dropdown-icon open" }) })
              ]
            }
          ),
          /* @__PURE__ */ u2("div", { className: "deck-widget-stats-content", children: items })
        ] }),
        rootElement
      );
    }
    ...
    _getStats() {
      switch (this.props.type) {
        ...
        case "luma":
          return Array.from(import_core26.luma.stats.stats.values())[0];
        case "device":
  ...
  StatsWidget.defaultProps = {
    ...import_core25.Widget.defaultProps,
    type: "deck",
    placement: "top-left",
    viewId: null,
  ...
  function FpsIcon({ getFps, onClick }) {
    ...
    return /* @__PURE__ */ u2(IconButton, { onClick, children: /* @__PURE__ */ u2("div", { className: "text", children: [
      "FPS",
      /* @__PURE__ */ u2("br", {}),
      fps
    ] }) });
