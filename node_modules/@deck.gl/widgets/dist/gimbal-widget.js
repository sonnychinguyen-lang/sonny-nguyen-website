...
export class GimbalWidget extends Widget {
    ...
    onRenderHTML(rootElement) {
        ...
        const ui = (_jsx("div", { className: "deck-widget-button", style: { perspective: 100, pointerEvents: 'auto' }, children: _jsx(Tooltip, { content: tooltipContent, children: _jsxs("button", { type: "button", onClick: () => {
                        for (const viewport of Object.values(this.viewports)) {
                            this.resetOrbitView(viewport);
                        }
                    }, "aria-label": this.props.label, style: { position: 'relative', width: 26, height: 26 }, children: [_jsx("svg", { className: "gimbal-outer-ring", width: "100%", height: "100%", viewBox: "0 0 26 26", style: {
                                position: 'absolute',
                                top: 0,
                                left: 0,
