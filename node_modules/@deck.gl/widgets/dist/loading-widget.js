...
export class LoadingWidget extends Widget {
    ...
    onRenderHTML(rootElement) {
        ...
        this.loading && (_jsx(IconButton, { className: "deck-widget-spinner", label: this.props.label, tooltip: this.props.tooltip, onClick: this.handleClick.bind(this) })), rootElement);
    }
    onRedraw({ layers }) {
