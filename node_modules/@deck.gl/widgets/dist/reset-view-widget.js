...
export class ResetViewWidget extends Widget {
    ...
    onRenderHTML(rootElement) {
        render(_jsx(IconButton, { className: "deck-widget-reset-focus", label: this.props.label, tooltip: this.props.tooltip, onClick: this.handleClick.bind(this) }), rootElement);
    }
    handleClick() {
