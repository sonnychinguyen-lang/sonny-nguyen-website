...
export class ThemeWidget extends Widget {
    ...
    onRenderHTML(rootElement) {
        ...
        render(_jsx(IconButton, { onClick: this._handleClick.bind(this), label: currentMode === 'dark' ? darkModeLabel : lightModeLabel, tooltip: currentMode === 'dark' ? darkModeTooltip : lightModeTooltip, className: currentMode === 'dark' ? 'deck-widget-moon' : 'deck-widget-sun' }), rootElement);
    }
    /**
