...
import type { RenderBundleEncoder, RenderBundleEncoderProps } from "./resources/render-bundle.js";
...
export { _getDefaultDebugValue } from "./device-defaults.js";
/**
...
export declare function isHTMLInCanvasSupported(): boolean;
/** Device feature names */
export type DeviceFeature = WebGPUDeviceFeature | WebGLDeviceFeature | WebGLCompressedTextureFeatures | BrowserDeviceFeature;
/** Browser APIs surfaced through luma.gl devices. */
export type BrowserDeviceFeature = 'html-in-canvas';
export type WebGPUDeviceFeature = 'core-features-and-limits' | 'depth-clip-control' | 'depth32float-stencil8' | 'texture-compression-bc' | 'texture-compression-bc-sliced-3d' | 'texture-compression-etc2' | 'texture-compression-astc' | 'texture-compression-astc-sliced-3d' | 'timestamp-query' | 'indirect-first-instance' | 'shader-f16' | 'rg11b10ufloat-renderable' | 'bgra8unorm-storage' | 'float32-filterable' | 'float32-blendable' | 'texture-formats-tier1' | 'texture-formats-tier2' | 'clip-distances' | 'dual-source-blending' | 'subgroups';
...
export declare abstract class Device {
     ...
     */
    writeBufferViaCommandEncoder(_commandEncoder: CommandEncoder, _destinationBuffer: Buffer, _data: ArrayBufferLike | ArrayBufferView | SharedArrayBuffer, _byteOffset?: number): void;
    /**
