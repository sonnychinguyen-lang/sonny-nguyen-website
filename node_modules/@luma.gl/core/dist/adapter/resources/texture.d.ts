...
import { type TextureFormat, type TextureMemoryLayout, type TextureFormatInfo } from "../../shadertypes/texture-types/texture-formats.js";
...
import { Sampler, type SamplerProps } from "./sampler.js";
...
export declare abstract class Texture extends Resource<TextureProps> {
    ...
    constructor(device: Device, props: TextureProps, backendProps?: {
    ...
    abstract copyElementImage(options: CopyElementImageOptions): {
        width: number;
        height: number;
    };
    /**
    ...
    _normalizeCopyElementImageOptions(options_: CopyElementImageOptions): Required<CopyElementImageOptions>;
