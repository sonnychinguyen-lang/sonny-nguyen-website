...
import { type CompositeShaderType, type VariableShaderType, type AttributeShaderType } from "../../shadertypes/shader-types/shader-types.js";
import { type Buffer } from "../resources/buffer.js";
import { type Sampler } from "../resources/sampler.js";
import { type ExternalTexture } from "../resources/external-texture.js";
...
export type BindingDeclaration = UniformBufferBindingLayout | StorageBufferBindingLayout | TextureBindingLayout | ExternalTextureBindingLayout | SamplerBindingLayout | StorageTextureBindingLayout;
...
/** Binding value */
export type Binding = TextureView | Texture | ExternalTexture | Sampler | Buffer | {
    buffer: Buffer;
    offset?: number;
    size?: number;
};
