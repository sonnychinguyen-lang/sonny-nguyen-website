...
var __exports__ = (() => {
  ...
  __export(bundle_exports, {
    ...
    getBufferLayoutAttributeNames: () => getBufferLayoutAttributeNames,
    getBufferLayoutMinAttributeLocation: () => getBufferLayoutMinAttributeLocation,
    getDataTypeByteLength: () => getDataTypeByteLength,
    ...
    getLogicalBufferSlots: () => getLogicalBufferSlots,
    getMinimumAttributeLocation: () => getMinimumAttributeLocation,
    getScratchArray: () => getScratchArray,
    getShaderAttributeLocationMap: () => getShaderAttributeLocationMap,
    ...
    readPixel: () => readPixel,
    resolveLogicalAttributeMappings: () => resolveLogicalAttributeMappings,
  ...
  // src/adapter/device-defaults.ts
  ...
  var Buffer2 = class _Buffer extends Resource {
    /** Index buffer */
    static INDEX = 16;
    /** Vertex buffer */
    static VERTEX = 32;
  ...
  var Device = class _Device {
    static defaultProps = { ...DEVICE_DEFAULT_PROPS };
    get [Symbol.toStringTag]() {
      return "Device";
    }
    toString() {
    ...
    wgslLanguageFeatures = /* @__PURE__ */ new Set();
    _textureCaps = {};
...
<code><pre>${htmlLog}</pre></code>`;
  ...
  var PipelineFactory = class _PipelineFactory {
    ...
    _getWebGPUAttachmentHash(props) {
      ...
      const depthStencilAttachmentFormat = props.depthStencilAttachmentFormat ?? (props.parameters?.depthWriteEnabled ? this.device.preferredDepthFormat : null);
  ...
  // src/adapter/resources/render-bundle.ts
  var RenderBundle = class _RenderBundle extends Resource {
    get [Symbol.toStringTag]() {
      return "RenderBundle";
    }
    constructor(device, props) {
  ...
  var RenderBundleEncoder = class _RenderBundleEncoder extends RenderPass {
    get [Symbol.toStringTag]() {
    ...
    constructor(device, props = {}) {
      ...
      super(
        ...
        _RenderBundleEncoder.bundleDefaultProps
      );
    }
    /**
  ...
  // src/adapter-utils/buffer-layout-utils.ts
  ...
  function getLogicalBufferSlots(shaderLayout, bufferLayout) {
  ...
  function resolveLogicalAttributeMappings(shaderLayout, bufferLayout, options) {
    ...
    return shaderLayout.attributes.map((attribute) => {
      ...
      const vertexFormat = bufferMapping?.vertexFormat || vertexFormatDecoder.getCompatibleVertexFormat(attributeTypeInfo);
      return {
        ...
        byteStride: bufferMapping?.byteStride ?? vertexFormatDecoder.getVertexFormatInfo(vertexFormat).byteLength,
        stepMode: bufferMapping?.stepMode || attribute.stepMode || (attribute.name.startsWith("instance") ? "instance" : "vertex")
      };
    }).sort((mappingA, mappingB) => mappingA.location - mappingB.location);
  }
  function getBufferLayoutMinAttributeLocation(bufferLayout, shaderLayout) {
