...
import type { CommandEncoder } from "../adapter/resources/command-encoder.js";
...
export declare class UniformStore<TPropGroups extends Record<string, Record<string, unknown>> = Record<string, Record<string, unknown>>> {
    ...
    uniformBlocks: Map<keyof TPropGroups, UniformBlock<Record<string, import("..").UniformValue>>>;
    ...
    }>, commandEncoder?: CommandEncoder): void;
    /**
     ...
     */
    updateUniformBuffer(uniformBufferName: keyof TPropGroups, commandEncoder?: CommandEncoder): false | string;
}
