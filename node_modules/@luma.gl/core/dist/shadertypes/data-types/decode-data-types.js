...
import { getFloat16ArrayConstructor, isFloat16ArrayConstructor } from "../../types.js";
/**
...
export function getTypedArrayFromDataType(type) {
    if (type === 'float16') {
...
export function getDataTypeByteLength(dataType) {
