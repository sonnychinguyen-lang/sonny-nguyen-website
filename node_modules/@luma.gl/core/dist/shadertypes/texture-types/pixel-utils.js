...
*/
export function readPixel(pixelData, x, y, bitsPerChannel) {
 ...
 */
export function readBitsFromDataView(dataView, bitOffset, bitCount) {
 ...
 */
export function writeBitsToDataView(dataView, bitOffset, bitCount, value) {
...
//# sourceMappingURL=pixel-utils.js.map