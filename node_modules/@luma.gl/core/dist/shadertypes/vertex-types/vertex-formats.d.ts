...
type VertexFormat3Components = 'uint8x3-webgl' | 'sint8x3-webgl' | 'unorm8x3-webgl' | 'snorm8x3-webgl' | 'uint16x3-webgl' | 'sint16x3-webgl' | 'unorm16x3-webgl' | 'snorm16x3-webgl' | 'uint32x3' | 'sint32x3' | 'float32x3';
