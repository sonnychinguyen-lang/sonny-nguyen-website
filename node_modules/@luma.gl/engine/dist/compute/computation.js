...
import { Buffer, ComputePipeline, PipelineFactory, ShaderFactory, UniformStore, assert, log, dataTypeDecoder } from '@luma.gl/core';
import { mergeShaderPluginModules, resolveShaderPlugins, ShaderAssembler, WGSLShaderAssembler } from '@luma.gl/shadertools';
import { isNumericArray } from '@math.gl/types';
import { ShaderInputs } from "../shader-inputs.js";
import { mergeShaderModules, mergeShaderModuleBindingsIntoLayout, shaderModuleHasUniforms } from "../utils/shader-module-utils.js";
...
export class Computation {
    ...
    constructor(device, props) {
        ...
        if (Object.keys(resolvedPlugins.vertexInputs).length > 0 ||
        ...
        const { source, getUniforms, shaderLayout: assembledShaderLayout } = shaderAssembler.assembleWGSLShader({
            platformInfo,
            ...this.props,
            modules,
            defines,
        ...
        const inferredShaderLayout = assembledShaderLayout ??
            device.getShaderLayout?.(this.source, { scanVertexAttributes: false });
        this.props.shaderLayout =
