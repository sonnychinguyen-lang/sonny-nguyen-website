...
export class OrbitControls {
    ...
    constructor(canvas, props = {}) {
        ...
        this.distance = clampNumber(this.props.distance, this.props.minDistance, this.props.maxDistance);
    ...
    update(timeMilliseconds) {
        if (this.previousTimeMilliseconds !== null &&
            this.props.enabled &&
            this.props.autoRotate &&
            !this.dragging) {
            const deltaSeconds = Math.min(Math.max(timeMilliseconds - this.previousTimeMilliseconds, 0) / 1000, 0.1);
    ...
    setProps(props) {
        ...
        if (props.distance !== undefined ||
            ...
            this.distance = clampNumber(props.distance ?? this.distance, this.props.minDistance, this.props.maxDistance);
        }
    }
    ...
    handlePointerMove = (event) => {
        ...
        if (this.activePointers.size > 1) {
            ...
            if (this.props.enableZoom && this.previousPinchDistance && distance > 0) {
                this.distance = clampNumber((this.distance * this.previousPinchDistance) / distance, this.props.minDistance, this.props.maxDistance);
            }
            this.lastPointer = center;
            this.previousPinchDistance = distance;
            return;
        ...
        if (this.props.enablePan && event.shiftKey) {
            ...
            this.pitch = clampNumber(this.pitch - deltaY * (this.props.pitchSpeed ?? this.props.rotateSpeed), this.props.minPitch, this.props.maxPitch);
        }
    };
    ...
    handleWheel = (event) => {
        ...
        this.distance = clampNumber(this.distance * Math.exp(deltaY * this.props.zoomSpeed), this.props.minDistance, this.props.maxDistance);
    };
}
