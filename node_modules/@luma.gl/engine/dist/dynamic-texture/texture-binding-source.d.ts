...
export type TextureBindingLayout = Extract<BindingDeclaration, {
 ...
 */
export declare function isTextureBindingSource(value: unknown): value is TextureBindingSource;
/**
 ...
 */
export declare function isTextureBindingLayout(bindingLayout: BindingDeclaration | null): bindingLayout is TextureBindingLayout;
/**
 ...
 */
export declare function getTextureBindingLayout(shaderLayout: Pick<ShaderLayout | ComputeShaderLayout, 'bindings'>, bindingName: string, options?: {
    fallbackGroup?: number;
}): TextureBindingLayout | null;
//# sourceMappingURL=texture-binding-source.d.ts.map