...
export type TextureDataAsyncProps = {
    ...
    dimension?: '2d';
    data?: Promise<Texture2DDataSource> | Texture2DDataSource | null;
} | {
    dimension: '3d';
...
export declare function getTexture2DSubresources(slice: number, lodData: Texture2DDataSource, baseLevelSize?: {
    width: number;
    height: number;
