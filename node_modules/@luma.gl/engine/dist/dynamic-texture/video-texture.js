...
function isHTMLVideoElementSource(source) {
...
function isVideoFrameSource(source) {
    if (!source || typeof source !== 'object') {
        return false;
    }
...
function isVideoTextureSourceReady(source) {
...
function getVideoTextureSourceSize(source) {
...
function getVideoTextureSourceFrameToken(source, sourceVersion) {
    if (isHTMLVideoElementSource(source)) {
