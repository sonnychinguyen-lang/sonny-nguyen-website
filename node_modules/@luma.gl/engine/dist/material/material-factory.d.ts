...
type MaterialBindings = Record<string, Binding | TextureBindingSource | import('../dynamic-buffer/dynamic-buffer').DynamicBuffer | import('../dynamic-buffer/dynamic-buffer').DynamicBufferRange>;
