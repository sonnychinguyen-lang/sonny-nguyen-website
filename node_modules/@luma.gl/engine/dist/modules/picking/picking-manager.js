...
export class PickingManager {
    ...
    positionTooltip(tooltipElement, mousePosition) {
        ...
        const maxLeft = Math.max(TOOLTIP_MARGIN_PIXELS, canvas.clientWidth - tooltipElement.offsetWidth - TOOLTIP_MARGIN_PIXELS);
        const maxTop = Math.max(TOOLTIP_MARGIN_PIXELS, canvas.clientHeight - tooltipElement.offsetHeight - TOOLTIP_MARGIN_PIXELS);
