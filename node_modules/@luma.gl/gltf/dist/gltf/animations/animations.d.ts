...
export type GLTFMaterialAnimationProperty = 'alphaCutoff' | 'anisotropyRotation' | 'anisotropyStrength' | 'attenuationColor' | 'attenuationDistance' | 'baseColorFactor' | 'bumpFactor' | 'clearcoatFactor' | 'clearcoatRoughnessFactor' | 'diffuseTransmissionFactor' | 'diffuseTransmissionColorFactor' | 'dispersion' | 'emissiveFactor' | 'emissiveStrength' | 'ior' | 'iridescenceFactor' | 'iridescenceIor' | 'iridescenceThicknessRange' | 'metallicRoughnessValues' | 'multiscatterColorFactor' | 'normalScale' | 'occlusionStrength' | 'sheenColorFactor' | 'sheenRoughnessFactor' | 'scatterAnisotropy' | 'specularColorFactor' | 'specularIntensityFactor' | 'thicknessFactor' | 'transmissionFactor';
...
export type GLTFCameraAnimationProperty = 'aspectRatio' | 'yfov' | 'znear' | 'zfar' | 'xmag' | 'ymag';
...
export type GLTFAnimationChannel = GLTFNodeAnimationChannel | GLTFMaterialAnimationChannel | GLTFTextureTransformAnimationChannel | GLTFCameraAnimationChannel | GLTFLightAnimationChannel;
