...
import { normalizeByteColor3 } from '@luma.gl/shadertools';
/** Parse KHR_lights_punctual extension into luma.gl light definitions */
export function parseGLTFLights(gltf, options = {}) {
    const lightDefs = options.lightDefinitions ||
...
function normalizeGLTFLightColor(color, useByteColors) {
    ...
    return normalizeByteColor3(color, false);
}
/**
