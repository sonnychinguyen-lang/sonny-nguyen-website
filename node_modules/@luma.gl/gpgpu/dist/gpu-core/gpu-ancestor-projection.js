...
export class GPUAncestorProjection {
    ...
    constructor(props) {
        ...
        if (this.parents.length !== this.output.length ||
    ...
    addToGraph(graph) {
        if (this.parents.buffer.graph !== graph ||
        ...
        graph.addComputePass({
            ...
            resources: [
                ...
                ...(this.visibilityValue
                    ? [{ buffer: this.visibilityValue, usage: 'storage-read' }]
                    : [])
            ],
            compile: ({ device }) => {
                ...
                return {
                    encode: ({ computePass, getBuffer }) => {
                        ...
                        computation.dispatch(computePass, Math.ceil(this.output.length / ANCESTOR_PROJECTION_WORKGROUP_SIZE));
                    },
...
//# sourceMappingURL=gpu-ancestor-projection.js.map