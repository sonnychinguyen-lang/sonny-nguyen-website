...
export function getBoundedDispatchLayout(operationName, elementCount, workgroupSize, maxComputeWorkgroupsPerDimension) {
...
export function getBoundedInvocationIndexSource(layout, workgroupSize) {
...
function validateWorkgroupSize(operationName, workgroupSize) {
    if (!Number.isSafeInteger(workgroupSize) ||
        workgroupSize < 2 ||
...
//# sourceMappingURL=gpu-dispatch-utils.js.map