 ...
 */
export function getGPUShaderSubgroupStrategy(device, options = {}) {
    const supportsSubgroups = device.features?.has('subgroups');
    const supportsRequiredLanguageFeatures = !options.requiresSubgroupId || device.wgslLanguageFeatures?.has('subgroup_id');
...
export function getSubgroupBallotHelpersWGSL() {
    return /* wgsl */ `
 ...
 */
export function getSubgroupCoalescedAtomicAddWGSL(acceptedExpression, keyExpression, atomicArrayName, maximumDistinctKeyCount) {
    return /* wgsl */ `
...
//# sourceMappingURL=gpu-subgroup-utils.js.map