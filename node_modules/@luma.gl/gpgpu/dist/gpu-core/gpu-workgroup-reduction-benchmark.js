...
export async function runGPUWorkgroupReductionBenchmark(device, props = {}) {
...
function makeBenchmarkPath(device, benchmarkId, strategy, workgroupCount, roundCount, dispatchCount) {
    ...
    return {
        strategy,
        barrierCountPerRound: strategy === 'subgroups'
...
//# sourceMappingURL=gpu-workgroup-reduction-benchmark.js.map