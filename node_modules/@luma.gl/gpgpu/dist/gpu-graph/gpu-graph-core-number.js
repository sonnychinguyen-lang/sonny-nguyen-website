...
import { addGPUGraphCoreNumberToGraphWithDispatchLimit } from "./gpu-graph-core-number-internals.js";
...
export class GPUGraphCoreNumber {
    ...
    constructor(props) {
        ...
        if (!Number.isSafeInteger(this.iterations) ||
            this.iterations < 0 ||
...
function validateDistinctCoreNumberOutputs(coreNumber) {
    ...
    const physicalAllocations = new Set();
...
//# sourceMappingURL=gpu-graph-core-number.js.map