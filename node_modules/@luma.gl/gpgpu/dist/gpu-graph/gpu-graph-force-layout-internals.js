...
import { getViewBinding, getViewElementOffset } from "../gpu-core/graph-data-view-utils.js";
...
export function addGPUGraphForceLayoutToGraphWithDispatchLimit(layout, commandGraph, maxComputeWorkgroupsPerDimension) {
...
function addForcePass(commandGraph, props) {
    ...
    const reverseConstants = state.reverseOffsets && state.reverseNeighbors && state.reverseOverflow
...
export function getGPUGraphForceLayoutDispatchLayout(elementCount, maxComputeWorkgroupsPerDimension) {
...
//# sourceMappingURL=gpu-graph-force-layout-internals.js.map