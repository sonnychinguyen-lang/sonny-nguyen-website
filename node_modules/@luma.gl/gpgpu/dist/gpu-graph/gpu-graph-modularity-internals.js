...
export function addGPUGraphModularityToGraphWithDispatchLimit(modularity, commandGraph, maxComputeWorkgroupsPerDimension) {
    ...
    const state = {
        ...
        contributions: modularity.communityContributions
            ? commandGraph.importGPUVector(`${modularity.id}-community-contributions`, modularity.communityContributions).data[0]
            : createTransientView(commandGraph, `${modularity.id}-contribution-scratch`, 'float32', vertexCount),
...
export function getGPUGraphModularityDispatchLayout(elementCount, maxComputeWorkgroupsPerDimension) {
...
//# sourceMappingURL=gpu-graph-modularity-internals.js.map