...
import { getGPUReductionStrategy } from "../gpu-core/gpu-reduction.js";
const PAGE_RANK_WORKGROUP_SIZE = 256;
/** Adds dangling-safe GPU PageRank using an explicit bounded dispatch limit. @internal */
export function addGPUGraphPageRankToGraphWithDispatchLimit(pageRank, commandGraph, maxComputeWorkgroupsPerDimension) {
...
export function getGPUGraphPageRankDispatchLayout(elementCount, maxComputeWorkgroupsPerDimension) {
    return getBoundedDispatchLayout('GPUGraphPageRank', elementCount, PAGE_RANK_WORKGROUP_SIZE, maxComputeWorkgroupsPerDimension);
}
//# sourceMappingURL=gpu-graph-page-rank-internals.js.map