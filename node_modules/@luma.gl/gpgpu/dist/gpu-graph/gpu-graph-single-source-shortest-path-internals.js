...
export function addGPUGraphSingleSourceShortestPathToGraphWithDispatchLimit(search, commandGraph, maxComputeWorkgroupsPerDimension) {
...
function addRelaxationPass(commandGraph, props) {
    ...
    const bindings = {
        ...
        ...(adjacency.edgeWeights
            ? { edgeWeights: { view: adjacency.edgeWeights, usage: 'storage-read' } }
            : {}),
...
export function getGPUGraphSingleSourceShortestPathDispatchLayout(elementCount, maxComputeWorkgroupsPerDimension) {
...
//# sourceMappingURL=gpu-graph-single-source-shortest-path-internals.js.map