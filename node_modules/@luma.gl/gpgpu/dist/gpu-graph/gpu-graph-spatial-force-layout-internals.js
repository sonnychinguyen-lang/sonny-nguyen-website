...
import { addGPUGridIndexToGraphWithDispatchLimit } from "../gpu-core/gpu-grid-index-internals.js";
...
export function addGPUGraphSpatialForceLayoutToGraphWithDispatchLimit(spatial, commandGraph, maxComputeWorkgroupsPerDimension) {
...
function addAttractionPass(commandGraph, props) {
    ...
    const reverseConstants = state.reverseOffsets && state.reverseNeighbors
...
const REVERSE_NEIGHBORS_OFFSET: u32 = ${getViewElementOffset(state.reverseNeighbors)}u;`
        : '';
    const reverseAttraction = state.reverseOffsets && state.reverseNeighbors
...
export function getGPUGraphSpatialForceLayoutDispatchLayout(elementCount, maxComputeWorkgroupsPerDimension) {
...
//# sourceMappingURL=gpu-graph-spatial-force-layout-internals.js.map