...
export function runCPUTransform({ elementWise, func, inputs, output, outputBuffer }) {
    // validate
...
export function getValueAtRow(source, index) {
