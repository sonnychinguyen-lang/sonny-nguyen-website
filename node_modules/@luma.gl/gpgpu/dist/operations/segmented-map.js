...
class SegmentedMapOperation extends Operation {
 ...
 */
export function segmentedMap(segments, vertexCount) {
...
function getRowOffset(table, rowIndex) {
    return (table.offset / table.ValueType.BYTES_PER_ELEMENT +
