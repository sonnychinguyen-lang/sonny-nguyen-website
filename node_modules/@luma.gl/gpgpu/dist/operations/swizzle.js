...
class SwizzleOperation extends Operation {
    name = 'swizzle';
    output;
...
export function swizzle(table, columns) {
...
function getSwizzledValue(source, columns) {
    const rowCount = source.isConstant ? 1 : source.length;
    const result = new source.ValueType(rowCount * columns.length);
