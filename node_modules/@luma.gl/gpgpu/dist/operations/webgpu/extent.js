...
import { getWebGPUDispatchLayout, getWebGPUDispatchWorkgroupIndex } from "./common/dispatch.js";
import { getWGSLType } from "./common/helper.js";
import { getInputBinding, getOutputBinding, getOutputWriter, getSourceValuesAccessor, RANDOM_ACCESS_WORKGROUP_SIZE } from "./common/random-access-transform.js";
export const extent = ({ inputs, output, target }) => {
    ...
    try {
        while (true) {
            ...
            const nextOutputBuffer = nextGroupCount === 1
                ? target
    ...
    const computation = new Computation(outputBuffer.device, {
        ...
        shaderLayout: {
            bindings: [
                ...(input.isConstant
                    ? []
                    : [{ name: 'sourceValues', type: 'storage', group: 0, location: 0 }]),
                {
                    name: 'result',
                    type: 'storage',
                    group: 0,
