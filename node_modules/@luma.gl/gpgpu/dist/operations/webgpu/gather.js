...
import { getWebGPUDispatchLayout, getWebGPUDispatchRowIndex } from "./common/dispatch.js";
import { getLiteralValue, getWGSLType } from "./common/helper.js";
import { getInputBinding, getOutputBinding, getOutputWriter, getSourceValuesAccessor, getZeroResultFunction, RANDOM_ACCESS_WORKGROUP_SIZE } from "./common/random-access-transform.js";
export const gather = async ({ inputs, output, target }) => {
