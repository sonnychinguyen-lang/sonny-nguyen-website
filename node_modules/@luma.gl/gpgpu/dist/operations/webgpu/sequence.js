...
export const sequence = ({ inputs, output, target }) => {
    const dispatchLayout = getWebGPUDispatchLayout(Math.ceil(output.length / WORKGROUP_SIZE), target.device.limits.maxComputeWorkgroupsPerDimension);
    const source = `\
