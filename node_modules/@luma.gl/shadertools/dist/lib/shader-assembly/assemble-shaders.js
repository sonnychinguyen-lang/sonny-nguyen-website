...
import { scanWGSLInterface } from "./wgsl-interface-scan.js";
import { preprocess } from "../preprocessor/preprocessor.js";
import { assembleShaderPluginVertexInputsWGSL, getShaderPluginVertexInputDeclarationsGLSL } from "./shader-plugin-vertex-inputs.js";
import { assembleShaderPluginVaryingsGLSL, assembleShaderPluginVaryingsWGSL } from "./shader-plugin-varyings.js";
...
function getWGSLShaderHooks(hookFunctionMap, hookInjections) {
    return (getShaderHooks(hookFunctionMap.vertex, hookInjections, 'wgsl') +
...
function relocateWGSLModuleBindingMatch(declarationMatch, params) {
    ...
    if (bindingToken === 'auto') {
        ...
        const location = registryLocation !== undefined
            ? registryLocation
            : allocateAutoBindingLocation(group, context.usedBindingsByGroup, module.name, relocationState.nextHintedBindingLocation ?? undefined, context.bindingRegistry);
