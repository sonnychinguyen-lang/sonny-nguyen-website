...
export declare function getShaderHooks(hookFunctions: Record<string, ShaderHook>, hookInjections: Record<string, ShaderInjection[]>, shaderLanguage?: 'glsl' | 'wgsl'): string;
/**
