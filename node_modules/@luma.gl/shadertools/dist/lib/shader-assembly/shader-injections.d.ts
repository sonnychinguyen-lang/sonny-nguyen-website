 ...
 * @returns
 */
export declare function injectShader(source: string, stage: 'vertex' | 'fragment', inject: Record<string, ShaderInjection[]>, injectStandardStubs?: boolean, language?: 'glsl' | 'wgsl', entryPoints?: {
    vertex?: string;
    fragment?: string;
}): string;
