import type { ShaderLayout, UniformBlockLayout } from '@luma.gl/core';
/**
 ...
 */
export declare function getShaderLayoutFromGLSL(gl: WebGL2RenderingContext, program: WebGLProgram, options?: {
