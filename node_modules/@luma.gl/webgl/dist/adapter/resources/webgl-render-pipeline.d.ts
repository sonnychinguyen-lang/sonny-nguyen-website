import type { RenderPipelineProps, RenderPipelineParameters, PrimitiveTopology, ShaderLayout, UniformValue, Bindings, BindingsByGroup, RenderPass, VertexArray } from '@luma.gl/core';
...
export declare class WEBGLRenderPipeline extends RenderPipeline {
    ...
    setBindings(bindings: Bindings | BindingsByGroup, options?: {
     ...
     */
    _areTexturesRenderable(bindings: Bindings): boolean;
    /** Apply any bindings (before each draw call) */
    _applyBindings(bindings: Bindings, _options?: {
        disableWarnings?: boolean;
    }): void;
    /**
     ...
     */
    _applyUniforms(uniforms: Record<string, UniformValue>): void;
