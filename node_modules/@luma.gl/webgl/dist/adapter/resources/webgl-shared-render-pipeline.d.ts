import { SharedRenderPipeline, type SharedRenderPipelineProps } from '@luma.gl/core';
import type { WebGLDevice } from "../webgl-device.js";
import type { WEBGLShader } from "./webgl-shader.js";
export declare class WEBGLSharedRenderPipeline extends SharedRenderPipeline {
    readonly device: WebGLDevice;
    readonly handle: WebGLProgram;
    readonly vs: WEBGLShader;
    readonly fs: WEBGLShader;
    linkStatus: 'pending' | 'success' | 'error';
    constructor(device: WebGLDevice, props: SharedRenderPipelineProps & {
        handle?: WebGLProgram;
        vs: WEBGLShader;
        fs: WEBGLShader;
    });
    ...
    _assignSamplerUniform(location: WebGLUniformLocation, activeInfo: WebGLActiveInfo, isArray: boolean, textureUnit: number): number;
    _waitForLinkComplete(): Promise<void>;
}
//# sourceMappingURL=webgl-shared-render-pipeline.d.ts.map