import { type Device, type TextureProps, type TextureViewProps, type Sampler, type SamplerProps, type CopyElementImageOptions, type CopyExternalImageOptions, type TextureReadOptions, type TextureWriteOptions, Buffer, Texture } from '@luma.gl/core';
import { GLSamplerParameters, GL, GLTextureTarget, GLTextureCubeMapTarget, GLTexelDataFormat, GLPixelType } from '@luma.gl/webgl/constants';
...
export declare class WEBGLTexture extends Texture {
    ...
    _framebufferAttachmentKey: string | null;
    ...
    copyImageData(options_: any): void;
    /**
    ...
    private _getRowByteAlignment;
    /**
     * Wraps a given texture into a framebuffer object, that can be further used
     * to read data from the texture object.
     */
    _getFramebuffer(): WEBGLFramebuffer;
    readDataSyncWebGL(options_?: TextureReadOptions): ArrayBuffer;
    /**
