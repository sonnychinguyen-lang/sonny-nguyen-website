...
import type { DeviceProps, DeviceInfo, DeviceTextureFormatCapabilities, CanvasContextProps, PresentationContextProps, PresentationContext, Buffer, Texture, Framebuffer, VertexArray, VertexArrayProps, BufferProps, ShaderProps, SamplerProps, TextureProps, ExternalTextureProps, FramebufferProps, RenderPipelineProps, SharedRenderPipeline, ComputePipeline, ComputePipelineProps, RenderBundleEncoderProps, CommandEncoder, CommandEncoderProps, TransformFeedbackProps, QuerySetProps, Resource, VertexFormat } from '@luma.gl/core';
...
export declare class WebGLDevice extends Device {
    ...
    createFence(): WEBGLFence;
    createRenderPipeline(props: RenderPipelineProps): WEBGLRenderPipeline;
    _createSharedRenderPipelineWebGL(props: RenderPipelineProps): SharedRenderPipeline;
    ...
    writeBufferViaCommandEncoder(_commandEncoder: CommandEncoder, destinationBuffer: Buffer, data: ArrayBufferLike | ArrayBufferView | SharedArrayBuffer, byteOffset?: number): void;
