...
// dist/constants/webgl-constants.js
var GLEnum;
...
var init_polyfill_webgl1_extensions = __esm({
  "dist/context/polyfills/polyfill-webgl1-extensions.js"() {
    import_constants = require("@luma.gl/webgl/constants");
    WEBGL1_STATIC_EXTENSIONS = {
      WEBGL_depth_texture: {
...
// dist/context/debug/debug-hooks.js
...
function warnDebugImportRequired() {
  if (!debugImportWarningShown) {
    ...
    import_core.log.warn("Import @luma.gl/webgl/debug before enabling WebGL debugging.")();
  }
}
var import_core, webglDeveloperToolsHooks, spectorHooks, debugImportWarningShown;
var init_debug_hooks = __esm({
  "dist/context/debug/debug-hooks.js"() {
...
var import_constants2, GL_PARAMETER_DEFAULTS, enable, hint, pixelStorei, bindFramebuffer, bindBuffer, GL_PARAMETER_SETTERS, GL_COMPOSITE_PARAMETER_SETTERS, GL_HOOKED_SETTERS, isEnabled, GL_PARAMETER_GETTERS, NON_CACHE_PARAMETERS;
var init_webgl_parameter_tables = __esm({
  "dist/context/parameters/webgl-parameter-tables.js"() {
    import_constants2 = require("@luma.gl/webgl/constants");
...
var init_webgl_device_info = __esm({
  "dist/adapter/device-helpers/webgl-device-info.js"() {
    import_constants3 = require("@luma.gl/webgl/constants");
...
var init_webgl_vertex_formats = __esm({
  "dist/adapter/converters/webgl-vertex-formats.js"() {
    import_constants4 = require("@luma.gl/webgl/constants");
  }
});
...
function getTextureFormatWebGL(format) {
  ...
  const decoded = import_core2.textureFormatDecoder.getInfo(format);
...
function getDepthStencilAttachmentWebGL(format) {
  const formatInfo = import_core2.textureFormatDecoder.getInfo(format);
...
var import_core3, WEBGL_FEATURES, WebGLDeviceFeatures;
var init_webgl_device_features = __esm({
  "dist/adapter/device-helpers/webgl-device-features.js"() {
    ...
    WEBGL_FEATURES = {
      ...
      "html-in-canvas": (gl) => (0, import_core3.isHTMLInCanvasSupported)() && typeof gl.texElementImage2D === "function",
    ...
    WebGLDeviceFeatures = class extends import_core3.DeviceFeatures {
      gl;
      extensions;
...
var import_core4, import_constants6, WebGLDeviceLimits;
var init_webgl_device_limits = __esm({
  "dist/adapter/device-helpers/webgl-device-limits.js"() {
    import_core4 = require("@luma.gl/core");
    import_constants6 = require("@luma.gl/webgl/constants");
    WebGLDeviceLimits = class extends import_core4.DeviceLimits {
...
var import_core5, import_constants7, WEBGLFramebuffer;
var init_webgl_framebuffer = __esm({
  "dist/adapter/resources/webgl-framebuffer.js"() {
    import_core5 = require("@luma.gl/core");
    import_constants7 = require("@luma.gl/webgl/constants");
    init_webgl_texture_table();
    WEBGLFramebuffer = class extends import_core5.Framebuffer {
      device;
      gl;
      handle;
      colorAttachments = [];
...
var import_core6, WebGLCanvasContext;
var init_webgl_canvas_context = __esm({
  "dist/adapter/webgl-canvas-context.js"() {
    import_core6 = require("@luma.gl/core");
    init_webgl_framebuffer();
    WebGLCanvasContext = class extends import_core6.CanvasContext {
      device;
      handle = null;
      _framebuffer = null;
...
var import_core7, WebGLPresentationContext;
var init_webgl_presentation_context = __esm({
  "dist/adapter/webgl-presentation-context.js"() {
    import_core7 = require("@luma.gl/core");
    WebGLPresentationContext = class extends import_core7.PresentationContext {
      device;
      handle = null;
      context2d;
      get [Symbol.toStringTag]() {
...
var import_core8, import_constants8, WEBGLBuffer;
var init_webgl_buffer = __esm({
  "dist/adapter/resources/webgl-buffer.js"() {
    import_core8 = require("@luma.gl/core");
    import_constants8 = require("@luma.gl/webgl/constants");
...
var import_core9, import_constants9, WEBGLShader;
var init_webgl_shader = __esm({
  "dist/adapter/resources/webgl-shader.js"() {
    import_core9 = require("@luma.gl/core");
    import_constants9 = require("@luma.gl/webgl/constants");
...
var import_core10, import_constants10;
var init_device_parameters = __esm({
  "dist/adapter/converters/device-parameters.js"() {
    import_core10 = require("@luma.gl/core");
    import_constants10 = require("@luma.gl/webgl/constants");
    init_unified_parameter_api();
  }
});
...
var init_sampler_parameters = __esm({
  "dist/adapter/converters/sampler-parameters.js"() {
    import_constants11 = require("@luma.gl/webgl/constants");
    init_device_parameters();
  }
});

// dist/adapter/resources/webgl-sampler.js
var import_core11, import_constants12, WEBGLSampler;
var init_webgl_sampler = __esm({
  "dist/adapter/resources/webgl-sampler.js"() {
    import_core11 = require("@luma.gl/core");
    import_constants12 = require("@luma.gl/webgl/constants");
...
var import_constants13, GL_DATA_TYPE_MAP;
var init_shader_formats = __esm({
  "dist/adapter/converters/shader-formats.js"() {
    import_constants13 = require("@luma.gl/webgl/constants");
    GL_DATA_TYPE_MAP = {
      [5124]: "sint32",
      [5125]: "uint32",
      [5122]: "sint16",
...
var init_webgl_texture = __esm({
  "dist/adapter/resources/webgl-texture.js"() {
    ...
    import_constants14 = require("@luma.gl/webgl/constants");
    init_webgl_texture_table();
    init_sampler_parameters();
    ...
    WEBGLTexture = class extends import_core13.Texture {
      ...
      readDataSyncWebGL(options_ = {}) {
        ...
        const ArrayType = (0, import_core13.getTypedArrayConstructor)(shaderType);
...
var import_constants15;
var init_set_uniform = __esm({
  "dist/adapter/helpers/set-uniform.js"() {
    import_constants15 = require("@luma.gl/webgl/constants");
  }
});
...
var import_constants16, WEBGL_SHADER_TYPES, WEBGL_SAMPLER_TO_TEXTURE_BINDINGS, NORMALIZED_SHADER_TYPE_TO_WEBGL;
var init_webgl_shadertypes = __esm({
  "dist/adapter/converters/webgl-shadertypes.js"() {
    import_constants16 = require("@luma.gl/webgl/constants");
    WEBGL_SHADER_TYPES = {
      [5126]: "f32",
      [35664]: "vec2<f32>",
      [35665]: "vec3<f32>",
...
function readUniformBlocks(gl, program, options) {
  ...
  for (const [blockIndex, uniformBlock] of knownBlocksByIndex) {
    ...
    try {
      ...
      import_core14.log.once(0, `WebGL uniform block reflection failed for "${uniformBlock.name}"; using supplied std140 metadata. ${message2}`)();
    }
  }
...
function readReflectedUniformBlock(gl, program, blockIndex, knownBlockName) {
  ...
  if (uniformInstancePrefixes.size === 1 && !uniformInstancePrefixes.has(blockInfo.name) && !uniformInstancePrefixes.has(blockAlias)) {
    ...
    import_core14.log.warn(`Uniform block "${blockInfo.name}" uses GLSL instance "${instanceName}". luma.gl binds uniform buffers by block name ("${blockInfo.name}") and alias ("${blockAlias}"). Prefer matching the instance name to one of those to avoid confusing silent mismatches.`)();
  }
  return blockInfo;
}
...
function makeUniformBlockBindingFromTypes(uniformBlockLayout) {
  const shaderBlockLayout = (0, import_core14.makeShaderBlockLayout)(uniformBlockLayout.uniformTypes, {
    layout: "std140"
  });
...
function parseUniformName(name) {
  ...
  const uniformName = (0, import_core14.assertDefined)(matches == null ? void 0 : matches[1], `Failed to parse GLSL uniform name ${name}`);
  return {
    name: uniformName,
...
var import_core14, import_constants17;
var init_get_shader_layout_from_glsl = __esm({
  "dist/adapter/helpers/get-shader-layout-from-glsl.js"() {
    import_core14 = require("@luma.gl/core");
    import_constants17 = require("@luma.gl/webgl/constants");
...
var import_core15, import_constants18, WEBGLRenderPipeline;
var init_webgl_render_pipeline = __esm({
  "dist/adapter/resources/webgl-render-pipeline.js"() {
    import_core15 = require("@luma.gl/core");
    import_constants18 = require("@luma.gl/webgl/constants");
    init_set_uniform();
    init_webgl_buffer();
    init_webgl_framebuffer();
    init_webgl_texture();
    ...
    WEBGLRenderPipeline = class extends import_core15.RenderPipeline {
      ...
      setBindings(bindings, options) {
        const flatBindings = (0, import_core15.flattenBindingsByGroup)((0, import_core15.normalizeBindingsByGroup)(this.shaderLayout, bindings));
...
var import_constants19, import_core16, LOG_PROGRAM_PERF_PRIORITY, WEBGLSharedRenderPipeline;
var init_webgl_shared_render_pipeline = __esm({
  "dist/adapter/resources/webgl-shared-render-pipeline.js"() {
    import_constants19 = require("@luma.gl/webgl/constants");
    import_core16 = require("@luma.gl/core");
    init_webgl_shadertypes();
    LOG_PROGRAM_PERF_PRIORITY = 4;
    WEBGLSharedRenderPipeline = class extends import_core16.SharedRenderPipeline {
      device;
      handle;
      vs;
      fs;
...
function _copyTextureToBuffer(device, options) {
  ...
  if (sourceTexture instanceof import_core17.Texture) {
...
var import_core17, import_constants20, WEBGLCommandBuffer;
var init_webgl_command_buffer = __esm({
  "dist/adapter/resources/webgl-command-buffer.js"() {
    import_core17 = require("@luma.gl/core");
    import_constants20 = require("@luma.gl/webgl/constants");
    init_webgl_texture_table();
    init_webgl_texture();
...
var init_webgl_topology_utils = __esm({
  "dist/adapter/helpers/webgl-topology-utils.js"() {
    import_constants21 = require("@luma.gl/webgl/constants");
  }
});
...
var init_webgl_render_pass = __esm({
  "dist/adapter/resources/webgl-render-pass.js"() {
    ...
    import_constants22 = require("@luma.gl/webgl/constants");
    init_with_parameters();
    init_unified_parameter_api();
    ...
    WEBGLRenderPass = class extends import_core18.RenderPass {
      ...
      setBindings(bindings, _options) {
        ...
        this.bindings = (0, import_core18.flattenBindingsByGroup)((0, import_core18.normalizeBindingsByGroup)(this.pipeline.shaderLayout, bindings));
      ...
      draw(options) {
        ...
        if (pipeline.linkStatus !== "success") {
          import_core18.log.info(2, `RenderPipeline:${pipeline.id}.draw() aborted - waiting for shader linking`)();
          return false;
        }
        if (!pipeline._areTexturesRenderable(this.bindings)) {
          import_core18.log.info(2, `RenderPipeline:${pipeline.id}.draw() aborted - textures not yet loaded`)();
          return false;
        }
...
var import_core20, import_constants23, import_env, WEBGLVertexArray;
var init_webgl_vertex_array = __esm({
  "dist/adapter/resources/webgl-vertex-array.js"() {
    import_core20 = require("@luma.gl/core");
    import_constants23 = require("@luma.gl/webgl/constants");
    import_env = require("@probe.gl/env");
    init_webgl_vertex_formats();
    init_fill_array();
    WEBGLVertexArray = class _WEBGLVertexArray extends import_core20.VertexArray {
      get [Symbol.toStringTag]() {
        return "VertexArray";
      }
      device;
      ...
      constructor(device, props) {
        ...
        for (const attributeInfo of Object.values((0, import_core20.getAttributeInfosFromLayouts)(props.shaderLayout, props.bufferLayout))) {
...
var init_webgl_transform_feedback = __esm({
  "dist/adapter/resources/webgl-transform-feedback.js"() {
    ...
    import_constants24 = require("@luma.gl/webgl/constants");
    init_index();
    init_webgl_topology_utils();
...
var init_webgl_query_set = __esm({
  "dist/adapter/resources/webgl-query-set.js"() {
    ...
    import_constants25 = require("@luma.gl/webgl/constants");
...
var init_format_utils = __esm({
  "dist/adapter/helpers/format-utils.js"() {
    import_constants26 = require("@luma.gl/webgl/constants");
  }
});
...
function readPixelsToArray(source, options) {
  ...
  const signedType = import_core24.dataTypeDecoder.getDataType(target2);
...
function getPixelArray(pixelArray, glType, glFormat, width, height, depth) {
  ...
  const ArrayType = import_core24.dataTypeDecoder.getTypedArrayConstructor(shaderType);
...
var init_webgl_texture_utils = __esm({
  "dist/adapter/helpers/webgl-texture-utils.js"() {
    ...
    import_constants27 = require("@luma.gl/webgl/constants");
    init_webgl_shadertypes();
    init_format_utils();
    init_shader_formats();
  }
...
var init_webgl_device = __esm({
  "dist/adapter/webgl-device.js"() {
    ...
    init_with_parameters();
    init_webgl_extensions();
    WebGLDevice = class _WebGLDevice extends import_core25.Device {
...
function resolveWebGLDebugProps(props) {
  return {
    ...props,
    debug: props.debug ?? import_core26.Device.defaultProps.debug,
    debugWebGL: props.debugWebGL ?? import_core26.Device.defaultProps.debugWebGL,
    debugSpectorJS: props.debugSpectorJS ?? Boolean(import_core26.log.get("debug-spectorjs"))
  };
}
...
var import_core26, LOG_LEVEL, WebGLAdapter, webgl2Adapter;
    ...
    WebGLAdapter = class extends import_core26.Adapter {
      ...
      async create(props = {}) {
        ...
        try {
          ...
          import_core26.log.groupCollapsed(LOG_LEVEL, `WebGLDevice ${device.id} created`)();
          ...
          import_core26.log.probe(LOG_LEVEL, message2)();
          import_core26.log.table(LOG_LEVEL, device.info)();
          return device;
        } finally {
          import_core26.log.groupEnd(LOG_LEVEL)();
          import_core26.log.info(LOG_LEVEL, `%cWebGL call tracing: luma.log.set('debug-webgl') `, "color: white; background: blue; padding: 2px 6px; border-radius: 3px;")();
        }
      }
    };
