...
export function getWebGPUTextureFormatCapabilities(format, features, featureLevel) {
    ...
    const requiredFeature = typeof staticCapabilities.create === 'string' && !staticCapabilities.create.endsWith('-webgl')
...
//# sourceMappingURL=webgpu-texture-capabilities.js.map